--insert into rainy_user(user_id,user_name,id) values('R6708125236','吴新玉','2452');
insert into rainy_user(user_id,user_name,id) values('R7710274520','唐红艳','2453');
...
SELECT 'revoke ' || rr.role_ext || ' from ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 2452 AND 2453;
...
DELETE FROM RSM_USER_ROLE T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2452 AND 2453);
DELETE FROM SEC_USER_GROUP T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2452 AND 2453);
DELETE FROM RAINY_USER_LOC T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2452 AND 2453);
DELETE FROM RAINY_USER_MERCH T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2452 AND 2453);
DELETE FROM RAINY_USER_POSITION T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2452 AND 2453);

insert into rainy_user_position(user_id,position_id) values('R6708125236',61);
insert into rainy_user_position(user_id,position_id) values('R7710274520',86);
-----------------------------------------------------------------------------
...
insert into rainy_user_merch(user_id,merch) values('R7710274520','75');
insert into rainy_user_merch(user_id,merch) values('R7710274520','76');
insert into rainy_user_merch(user_id,merch) values('R7710274520','78');
-----------------------------------------------------------------------
...
insert into rainy_user_loc (user_id,loc)values('R7710274520','130011');
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 2452 AND 2453
