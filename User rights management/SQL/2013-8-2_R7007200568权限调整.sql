SELECT * FROM RAINY_USER T WHERE T.USER_ID='R7007200568';

--权限变更的用户修改ID列，从BBG_Security_Application_User_List表中获取
SELECT * FROM RAINY_USER
WHERE USER_ID= 'R7007200568' FOR UPDATE;
...
where  RU.USER_ID IN ( 'R7007200568' );
...
DELETE FROM RSM_USER_ROLE WHERE user_id IN ('R7007200568' );
DELETE FROM SEC_USER_GROUP WHERE USER_ID IN ('R7007200568' );
DELETE FROM RAINY_USER_LOC WHERE USER_ID IN ('R7007200568' );
DELETE FROM RAINY_USER_MERCH WHERE USER_ID IN ('R7007200568' );
DELETE FROM RAINY_USER_POSITION WHERE USER_ID IN ('R7007200568' );

insert into rainy_user_position(user_id,position_id) values('R7007200568',52);

insert into rainy_user_merch(user_id,merch) values('R7007200568','16');
insert into rainy_user_merch(user_id,merch) values('R7007200568','17');
insert into rainy_user_merch(user_id,merch) values('R7007200568','18');
insert into rainy_user_merch(user_id,merch) values('R7007200568','19');

insert into rainy_user_loc (user_id,loc)values('R7007200568','ALL');
