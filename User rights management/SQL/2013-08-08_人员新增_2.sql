--insert into rainy_user(user_id,user_name,id) values('R840108831X','唐政伟','1448');

SELECT * FROM RAINY_USER T WHERE T.USER_ID='R840108831X';
SELECT * FROM RAINY_USER_MERCH T WHERE T.USER_ID='R840108831X';
SELECT * FROM RAINY_USER_POSITION T WHERE T.USER_ID='R840108831X';
SELECT * FROM RAINY_USER_LOC T WHERE T.USER_ID='R840108831X';

--权限变更的用户修改ID列，从BBG_Security_Application_User_List表中获取
SELECT * FROM RAINY_USER
WHERE USER_ID= 'R840108831X' FOR UPDATE;
...
DELETE FROM RSM_USER_ROLE T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID =1448);
--DELETE FROM SEC_USER_GROUP T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID =1448);
--DELETE FROM RAINY_USER_LOC T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID =1448);
--DELETE FROM RAINY_USER_MERCH T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID =1448);
DELETE FROM RAINY_USER_POSITION T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID =1448);

SELECT * FROM SEC_USER_GROUP WHERE USER_ID='R840108831X'

insert into rainy_user_position(user_id,position_id) values('R840108831X',95);
