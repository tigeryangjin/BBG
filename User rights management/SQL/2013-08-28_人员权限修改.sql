SELECT * FROM RAINY_USER          WHERE USER_ID= 'R8008203614';
SELECT * FROM RAINY_USER_POSITION  WHERE USER_ID= 'R8008203614';
SELECT * FROM RAINY_USER_MERCH    WHERE USER_ID= 'R8008203614';
SELECT * FROM RAINY_USER_LOC      WHERE USER_ID= 'R8008203614';

SELECT * FROM RAINY_USER          WHERE USER_ID= 'R8612211141';
SELECT * FROM RAINY_USER_POSITION  WHERE USER_ID= 'R8612211141';
SELECT * FROM RAINY_USER_MERCH    WHERE USER_ID= 'R8612211141';
SELECT * FROM RAINY_USER_LOC      WHERE USER_ID= 'R8612211141';

insert into rainy_user(user_id,user_name,id) values('R8008203614','赵朝虎','2229');
insert into rainy_user(user_id,user_name,id) values('R8612211141','陈聪','2230');

--权限变更的用户修改ID列，从BBG_Security_Application_User_List表中获取
SELECT * FROM RAINY_USER
WHERE USER_ID in( 'R8008203614','R8612211141') FOR UPDATE;
...
SELECT 'revoke ' || rr.role_ext || ' from ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 2229 AND 2230;
...
where  RU.ID BETWEEN 2229 AND 2230 ;
...
DELETE FROM RSM_USER_ROLE T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2229 AND 2230);
DELETE FROM SEC_USER_GROUP T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2229 AND 2230);
DELETE FROM RAINY_USER_LOC T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2229 AND 2230);
DELETE FROM RAINY_USER_MERCH T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2229 AND 2230);
DELETE FROM RAINY_USER_POSITION T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2229 AND 2230);

insert into rainy_user_position(user_id,position_id) values('R8612211141',85);
insert into rainy_user_position(user_id,position_id) values('R8008203614',5);

insert into rainy_user_merch(user_id,merch) values('R8008203614','31');
insert into rainy_user_merch(user_id,merch) values('R8008203614','34');
insert into rainy_user_merch(user_id,merch) values('R8008203614','39');
insert into rainy_user_merch(user_id,merch) values('R8612211141','21');
insert into rainy_user_merch(user_id,merch) values('R8612211141','22');
insert into rainy_user_merch(user_id,merch) values('R8612211141','23');
insert into rainy_user_merch(user_id,merch) values('R8612211141','24');
insert into rainy_user_merch(user_id,merch) values('R8612211141','25');
insert into rainy_user_merch(user_id,merch) values('R8612211141','26');
insert into rainy_user_merch(user_id,merch) values('R8612211141','29');

insert into rainy_user_loc (user_id,loc)values('R8008203614','118004');
insert into rainy_user_loc (user_id,loc)values('R8008203614','118010');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120043');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120044');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120073');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120084');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120088');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120092');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120111');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120127');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120138');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120148');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120152');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120174');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120180');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120197');
insert into rainy_user_loc (user_id,loc)values('R8008203614','120198');
insert into rainy_user_loc (user_id,loc)values('R8612211141','120082');
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 2229 AND 2230
