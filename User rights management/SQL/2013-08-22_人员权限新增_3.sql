insert into rainy_user(user_id,user_name,id) values('R8703090774','周波','2194');
...
insert into rainy_user_position(user_id,position_id) values('R8703090774',83);

insert into rainy_user_merch(user_id,merch) values('R8703090774','ALL');

insert into rainy_user_loc (user_id,loc)values('R8703090774','ALL');
