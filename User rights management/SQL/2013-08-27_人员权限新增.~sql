insert into rainy_user(user_id,user_name,id) values('R9005207227','王婧','2228');
...
insert into rainy_user_position(user_id,position_id) values('R9005207227',7);

insert into rainy_user_merch(user_id,merch) values('R9005207227','18');

insert into rainy_user_loc (user_id,loc)values('R9005207227','ALL');
