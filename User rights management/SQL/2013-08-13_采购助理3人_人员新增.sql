insert into rainy_user(user_id,user_name,id) values('R8812217470','肖晓鸣','1999');
insert into rainy_user(user_id,user_name,id) values('R8712098024','姚芳','2000');
insert into rainy_user(user_id,user_name,id) values('R8909180027','潘婷','2001');
...
to ' || ru.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user ru
  WHERE RU.ID BETWEEN 1999 AND 2001 ;

insert into rainy_user_position(user_id,position_id) values('R8812217470',7);
insert into rainy_user_position(user_id,position_id) values('R8712098024',7);
insert into rainy_user_position(user_id,position_id) values('R8909180027',7);
----------------------------------------
insert into rainy_user_merch(user_id,merch) values('R8712098024','12');
insert into rainy_user_merch(user_id,merch) values('R8909180027','12');
insert into rainy_user_merch(user_id,merch) values('R8812217470','29');
-----------------------------------------------------
insert into rainy_user_loc (user_id,loc)values('R8812217470','ALL');
insert into rainy_user_loc (user_id,loc)values('R8712098024','ALL');
insert into rainy_user_loc (user_id,loc)values('R8909180027','ALL');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 1999 AND 2001;
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 1999 AND 2001
