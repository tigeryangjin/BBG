--insert into rainy_user(user_id,user_name,id) values('R7403190025','谢君','963');
--insert into rainy_user(user_id,user_name,id) values('R7202220027','朱安平','964');
insert into rainy_user(user_id,user_name,id) values('R8106050323','刘甜','965');
insert into rainy_user(user_id,user_name,id) values('R8710108020','贺雪媛','966');


--权限变更的用户修改ID列，从BBG_Security_Application_User_List表中获取
SELECT * FROM RAINY_USER
WHERE USER_ID= 'R7202220027' FOR UPDATE
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID IN ('R8106050323','R8710108020') ;
  
--删除原网点
--删除表中用户数据，权限清除后需要删除的表
DELETE FROM RSM_USER_ROLE WHERE user_id IN ('R7403190025', 'R7202220027' );
DELETE FROM SEC_USER_GROUP WHERE USER_ID IN ('R7403190025', 'R7202220027' );
DELETE FROM RAINY_USER_LOC WHERE USER_ID IN ('R7403190025', 'R7202220027' );
DELETE FROM RAINY_USER_MERCH WHERE USER_ID IN ('R7403190025', 'R7202220027' );
DELETE FROM RAINY_USER_POSITION WHERE USER_ID IN ('R7403190025', 'R7202220027' );  
...
insert into rainy_user_position(user_id,position_id) values('R8106050323',64);
insert into rainy_user_position(user_id,position_id) values('R8710108020',64);


--
insert into rainy_user_merch(user_id,merch) values('R7403190025','ALL');
insert into rainy_user_merch(user_id,merch) values('R7202220027','ALL');
insert into rainy_user_merch(user_id,merch) values('R8106050323','ALL');
insert into rainy_user_merch(user_id,merch) values('R8710108020','ALL');
...
insert into rainy_user_loc (user_id,loc)values('R7202220027','120194');
...
insert into rainy_user_loc (user_id,loc)values('R8106050323','120001');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120008');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120010');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120011');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120014');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120072');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120100');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120115');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120141');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120145');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120153');
insert into rainy_user_loc (user_id,loc)values('R8106050323','120176');
insert into rainy_user_loc (user_id,loc)values('R8106050323','130009');
insert into rainy_user_loc (user_id,loc)values('R8106050323','130014');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120001');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120008');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120010');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120011');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120014');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120072');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120100');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120115');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120141');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120145');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120153');
insert into rainy_user_loc (user_id,loc)values('R8710108020','120176');
insert into rainy_user_loc (user_id,loc)values('R8710108020','130009');
insert into rainy_user_loc (user_id,loc)values('R8710108020','130014');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.USER_ID IN ('R7403190025','R7202220027','R8106050323','R8710108020' );
...
from rainy_user 
where  USER_ID IN ('R7403190025','R7202220027','R8106050323','R8710108020' )
...
where  RU.USER_ID IN ('R7403190025','R7202220027','R8106050323','R8710108020' );
