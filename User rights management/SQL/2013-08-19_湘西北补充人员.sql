insert into rainy_user(user_id,user_name,id) values('R8608232570','范军','2140');
insert into rainy_user(user_id,user_name,id) values('R8511170034','莫小磊','2141');
--权限变更的用户修改ID列，从BBG_Security_Application_User_List表中获取
SELECT * FROM RAINY_USER
WHERE USER_ID= 'R8511170034' FOR UPDATE;
...
select * from rainy_user where user_id='R8608232570';
select * from rainy_user_position where user_id='R8608232570';
select * from rainy_user_merch where user_id='R8608232570';
select * from rainy_user_loc where user_id='R8608232570';
select * from sec_user_group where user_id='R8608232570';
select * from sec_group where group_id=1371;

DELETE SEC_USER_GROUP WHERE group_id=1371 AND user_id='R8608232570';
DELETE RAINY_USER_LOC WHERE USER_ID='R8608232570' AND LOC='120097';

insert into rainy_user_position(user_id,position_id) values('R8608232570',85);
insert into rainy_user_position(user_id,position_id) values('R8511170034',86);

insert into rainy_user_merch(user_id,merch) values('R8511170034','12');
insert into rainy_user_merch(user_id,merch) values('R8511170034','13');
insert into rainy_user_merch(user_id,merch) values('R8511170034','14');
insert into rainy_user_merch(user_id,merch) values('R8511170034','15');

insert into rainy_user_loc (user_id,loc)values('R8608232570','120080');
insert into rainy_user_loc (user_id,loc)values('R8511170034','120188');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 2140 AND 2141;
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 2140 AND 2141
...
where  RU.ID BETWEEN 2140 AND 2141 ;
