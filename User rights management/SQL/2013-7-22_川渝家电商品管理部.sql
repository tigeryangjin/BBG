SELECT * FROM RAINY_USER WHERE USER_ID IN ('R8307204587','R800125753X','R8309291312');

--insert into rainy_user(user_id,user_name,id) values('R8307204587','陶云艳','971');
--insert into rainy_user(user_id,user_name,id) values('R800125753X','缪世友','972');
insert into rainy_user(user_id,user_name,id) values('R8309291312','姚灿','973');
...
SELECT 'revoke ' || rr.role_ext || ' from ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.USER_ID IN ( 'R8307204587','R800125753X');
...
where  RU.USER_ID IN ('R8307204587','R800125753X');
...
DELETE FROM RSM_USER_ROLE WHERE user_id IN ('R8307204587','R800125753X' );
DELETE FROM SEC_USER_GROUP WHERE USER_ID IN ('R8307204587','R800125753X' );
DELETE FROM RAINY_USER_LOC WHERE USER_ID IN ('R8307204587','R800125753X' );
DELETE FROM RAINY_USER_MERCH WHERE USER_ID IN ('R8307204587','R800125753X' );
DELETE FROM RAINY_USER_POSITION WHERE USER_ID IN ('R8307204587','R800125753X' );
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID='R8309291312' ;
  
--  
insert into rainy_user_position(user_id,position_id) values('R8307204587',72);
insert into rainy_user_position(user_id,position_id) values('R800125753X',72);
insert into rainy_user_position(user_id,position_id) values('R8309291312',72);

--
insert into rainy_user_merch(user_id,merch) values('R8307204587','71');
insert into rainy_user_merch(user_id,merch) values('R8307204587','72');
insert into rainy_user_merch(user_id,merch) values('R8307204587','73');
insert into rainy_user_merch(user_id,merch) values('R8307204587','74');
insert into rainy_user_merch(user_id,merch) values('R8307204587','75');
insert into rainy_user_merch(user_id,merch) values('R8307204587','76');
insert into rainy_user_merch(user_id,merch) values('R8307204587','77');
insert into rainy_user_merch(user_id,merch) values('R8307204587','78');
insert into rainy_user_merch(user_id,merch) values('R800125753X','71');
insert into rainy_user_merch(user_id,merch) values('R800125753X','72');
insert into rainy_user_merch(user_id,merch) values('R800125753X','73');
insert into rainy_user_merch(user_id,merch) values('R800125753X','74');
insert into rainy_user_merch(user_id,merch) values('R800125753X','75');
insert into rainy_user_merch(user_id,merch) values('R800125753X','76');
insert into rainy_user_merch(user_id,merch) values('R800125753X','77');
insert into rainy_user_merch(user_id,merch) values('R800125753X','78');
insert into rainy_user_merch(user_id,merch) values('R8309291312','71');
insert into rainy_user_merch(user_id,merch) values('R8309291312','72');
insert into rainy_user_merch(user_id,merch) values('R8309291312','73');
insert into rainy_user_merch(user_id,merch) values('R8309291312','74');
insert into rainy_user_merch(user_id,merch) values('R8309291312','75');
insert into rainy_user_merch(user_id,merch) values('R8309291312','76');
insert into rainy_user_merch(user_id,merch) values('R8309291312','77');
insert into rainy_user_merch(user_id,merch) values('R8309291312','78');

--
insert into rainy_user_loc (user_id,loc)values('R8307204587','ALL');
insert into rainy_user_loc (user_id,loc)values('R800125753X','ALL');
insert into rainy_user_loc (user_id,loc)values('R8309291312','ALL');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND rup.position_id = rpr.position_id
   AND rpr.role_id = rr.role_id
   AND RU.USER_ID IN ('R8307204587','R800125753X','R8309291312' );
...
from rainy_user 
where  USER_ID IN ('R8307204587','R800125753X','R8309291312' )
...
'uniquemember: cn='||a.USER_ID||',cn=users,dc=bbg' ||CHR (10 )
FROM RAINY_USER_MERCH a left join rainy_user ru on a.user_id=ru.user_id
where  RU.USER_ID IN ('R8307204587','R800125753X','R8309291312' );
