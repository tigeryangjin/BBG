insert into rainy_user(user_id,user_name,id) values('R8611215121','杜凌琳','1429');
insert into rainy_user(user_id,user_name,id) values('R9102074011','郑星','1430');
...
to ' || ru.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user ru
  WHERE RU.ID BETWEEN 1429 AND 1430 ;


insert into rainy_user_position(user_id,position_id) values('R8611215121',95);
insert into rainy_user_position(user_id,position_id) values('R9102074011',96);

insert into rainy_user_merch(user_id,merch) values('R8611215121','ALL');
insert into rainy_user_merch(user_id,merch) values('R9102074011','ALL');

insert into rainy_user_loc (user_id,loc)values('R8611215121','120194');
insert into rainy_user_loc (user_id,loc)values('R9102074011','120194');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 1429 AND 1430;
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 1429 AND 1430
