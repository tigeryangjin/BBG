SELECT * FROM RAINY_USER WHERE USER_ID='R7906180819';
SELECT * FROM RAINY_USER_POSITION WHERE USER_ID='R7906180819';
SELECT * FROM RAINY_POSITION_ROLE WHERE POSITION_ID=3;
SELECT * FROM RAINY_ROLE WHERE ROLE_ID=182;
SELECT * FROM RAINY_USER_LOC WHERE USER_ID='R7906180819';
SELECT * FROM RAINY_USER_MERCH WHERE USER_ID='R7906180819';

insert into RAINY_POSITION_ROLE(role_id,position_id) values(184,3);
insert into RAINY_POSITION_ROLE(role_id,position_id) values(183,3);
...
AND RU.USER_ID IN ( 'R7906180819' )
AND RA.ROLE_ID IN (183,184);
