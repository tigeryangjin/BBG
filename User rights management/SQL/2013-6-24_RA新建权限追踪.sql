...
Inventory Adjustment Create PC


     R7409071024     陈星 AQldl766   无新建
     R8005092556     黄亮 KBdsf883   有新建
SELECT * FROM RAINY_USER
     
     SELECT * FROM RAINY_USER_POSITION WHERE USER_ID IN ('R7409071024','R8005092556');
