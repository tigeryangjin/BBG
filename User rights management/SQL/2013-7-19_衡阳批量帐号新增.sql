--insert into rainy_user(user_id,user_name,id) values('R7707280046','贺冰','959');
insert into rainy_user(user_id,user_name,id) values('R8510053314','唐宗兴','960');
insert into rainy_user(user_id,user_name,id) values('R9003240087','冯倩','961');
insert into rainy_user(user_id,user_name,id) values('R9103233515','楚鼎','962');

--权限变更的用户修改ID列，从BBG_Security_Application_User_List表中获取
SELECT * FROM RAINY_USER
WHERE USER_ID= 'R7707280046' FOR UPDATE

--删除原网点
DELETE FROM RAINY_USER_LOC WHERE USER_ID IN ('R7707280046' );
--SELECT * FROM RAINY_USER_LOC WHERE USER_ID IN ('R4670225005' );
DELETE FROM SEC_USER_GROUP 
WHERE USER_ID IN ('R7707280046' );
--修改密码
update rainy_user t
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID IN ('R8510053314','R9003240087','R9103233515') ;
  
--
--insert into rainy_user_position(user_id,position_id) values('R7707280046',64);
insert into rainy_user_position(user_id,position_id) values('R8510053314',64);
insert into rainy_user_position(user_id,position_id) values('R8510053314',96);
insert into rainy_user_position(user_id,position_id) values('R9003240087',65);
insert into rainy_user_position(user_id,position_id) values('R9003240087',66);
insert into rainy_user_position(user_id,position_id) values('R9103233515',65);
insert into rainy_user_position(user_id,position_id) values('R9103233515',66);

--
--insert into rainy_user_merch(user_id,merch) values('R7707280046','ALL');
insert into rainy_user_merch(user_id,merch) values('R8510053314','ALL');
insert into rainy_user_merch(user_id,merch) values('R9003240087','ALL');
insert into rainy_user_merch(user_id,merch) values('R9103233515','ALL');

--
insert into rainy_user_loc (user_id,loc)values('R7707280046','ALL');
insert into rainy_user_loc (user_id,loc)values('R8510053314','ALL');
insert into rainy_user_loc (user_id,loc)values('R9003240087','ALL');
insert into rainy_user_loc (user_id,loc)values('R9103233515','ALL');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.USER_ID IN ('R8510053314','R9003240087','R9103233515' );
...
from rainy_user 
where  USER_ID IN ('R8510053314','R9003240087','R9103233515' )
and user_id not in ( select user_id from user_attrib );

--插入sec_user_group表，分二种情况插入
SELECT * FROM SEC_USER_GROUP 
WHERE USER_ID IN ('R7707280046','R8510053314','R9003240087','R9103233515' );
--Location地点
INSERT INTO sec_user_group
  SELECT sg.group_id , ru.user_id
   ...
   WHERE ru.user_id = rul.user_id
     ...
     AND RU.USER_ID IN ('R7707280046','R8510053314','R9003240087','R9103233515' );
--Department大类    
INSERT INTO sec_user_group
  SELECT sg.group_id , ru.user_id
...
where  RU.USER_ID IN ('R7707280046','R8510053314','R9003240087','R9103233515' );
