insert into rainy_user(user_id,user_name,id) values('R7308260786','谭亚辉','1036');
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID='R7308260786' ;



insert into rainy_user_position(user_id,position_id) values('R7308260786',10);

insert into rainy_user_merch(user_id,merch) values('R7308260786','31');

insert into rainy_user_loc (user_id,loc)values('R7308260786','ALL');
...
where  RU.USER_ID IN ('R7308260786' );
