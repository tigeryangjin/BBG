insert into rainy_user(user_id,user_name,id) values('R9004285410','王峥','2142');
...
insert into rainy_user_position(user_id,position_id) values('R9004285410',95);

insert into rainy_user_merch(user_id,merch) values('R9004285410','ALL');

insert into rainy_user_loc (user_id,loc)values('R9004285410','120100');
