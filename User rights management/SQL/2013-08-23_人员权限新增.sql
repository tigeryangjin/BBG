--insert into rainy_user(user_id,user_name,id) values('R8912121974','谢玄','2195');
insert into rainy_user(user_id,user_name,id) values('R7611230044','康松英','2196');
--insert into rainy_user(user_id,user_name,id) values('R7307104167','王宋娟','2197');
--insert into rainy_user(user_id,user_name,id) values('R8611157934','刘铁金','2198');
...
to ' || ru.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user ru
  WHERE RU.ID BETWEEN 2195 AND 2198 ;
...
WHERE USER_ID IN( 'R8912121974','R7307104167','R8611157934') FOR UPDATE;
...
SELECT 'revoke ' || rr.role_ext || ' from ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 2195 AND 2198;
...
DELETE FROM RSM_USER_ROLE T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2195 AND 2198);
DELETE FROM SEC_USER_GROUP T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2195 AND 2198);
DELETE FROM RAINY_USER_LOC T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2195 AND 2198);
DELETE FROM RAINY_USER_MERCH T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2195 AND 2198);
DELETE FROM RAINY_USER_POSITION T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2195 AND 2198);


insert into rainy_user_position(user_id,position_id) values('R8912121974',86);
insert into rainy_user_position(user_id,position_id) values('R7611230044',86);
insert into rainy_user_position(user_id,position_id) values('R7307104167',85);
insert into rainy_user_position(user_id,position_id) values('R8611157934',82);


insert into rainy_user_merch(user_id,merch) values('R8912121974','32');
insert into rainy_user_merch(user_id,merch) values('R8912121974','35');
insert into rainy_user_merch(user_id,merch) values('R8912121974','42');
insert into rainy_user_merch(user_id,merch) values('R7611230044','27');
insert into rainy_user_merch(user_id,merch) values('R7611230044','31');
insert into rainy_user_merch(user_id,merch) values('R7611230044','34');
insert into rainy_user_merch(user_id,merch) values('R7611230044','39');
insert into rainy_user_merch(user_id,merch) values('R7307104167','12');
insert into rainy_user_merch(user_id,merch) values('R7307104167','13');
insert into rainy_user_merch(user_id,merch) values('R7307104167','14');
insert into rainy_user_merch(user_id,merch) values('R7307104167','15');
insert into rainy_user_merch(user_id,merch) values('R7307104167','16');
insert into rainy_user_merch(user_id,merch) values('R7307104167','17');
insert into rainy_user_merch(user_id,merch) values('R7307104167','18');
insert into rainy_user_merch(user_id,merch) values('R7307104167','19');
insert into rainy_user_merch(user_id,merch) values('R7307104167','21');
insert into rainy_user_merch(user_id,merch) values('R7307104167','22');
insert into rainy_user_merch(user_id,merch) values('R7307104167','23');
insert into rainy_user_merch(user_id,merch) values('R7307104167','24');
insert into rainy_user_merch(user_id,merch) values('R7307104167','25');
insert into rainy_user_merch(user_id,merch) values('R7307104167','26');
insert into rainy_user_merch(user_id,merch) values('R7307104167','29');
insert into rainy_user_merch(user_id,merch) values('R8611157934','ALL');


insert into rainy_user_loc (user_id,loc)values('R8912121974','120159');
insert into rainy_user_loc (user_id,loc)values('R7611230044','120103');
insert into rainy_user_loc (user_id,loc)values('R7307104167','120105');
insert into rainy_user_loc (user_id,loc)values('R8611157934','ALL');
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 2195 AND 2198
