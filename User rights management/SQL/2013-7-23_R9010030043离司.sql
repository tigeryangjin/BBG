SELECT * FROM RAINY_USER WHERE USER_ID='R9010030043';
...
where  RU.USER_ID IN ( 'R9010030043' );
...
DELETE FROM RAINY_USER WHERE USER_ID IN ('R9010030043' );
DELETE FROM RAINY_USER_LOC WHERE USER_ID IN ('R9010030043' );
DELETE FROM RAINY_USER_MERCH WHERE USER_ID IN ('R9010030043' );
DELETE FROM RAINY_USER_POSITION WHERE USER_ID IN ('R9010030043' );
DELETE FROM RSM_USER_ROLE WHERE user_id IN ('R9010030043' );
DELETE FROM SEC_USER_GROUP WHERE USER_ID IN ('R9010030043' );
DELETE FROM RAINY_USER_LOC WHERE USER_ID IN ('R9010030043' );
DELETE FROM RAINY_USER_MERCH WHERE USER_ID IN ('R9010030043' );
DELETE FROM RAINY_USER_POSITION WHERE USER_ID IN ('R9010030043' );
