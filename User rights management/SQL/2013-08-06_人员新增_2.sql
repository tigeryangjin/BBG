insert into rainy_user(user_id,user_name,id) values('R7204135445','周松枝','1431');
...
insert into rainy_user_position(user_id,position_id) values('R7204135445',61);

insert into rainy_user_merch(user_id,merch) values('R7204135445','ALL');

insert into rainy_user_loc (user_id,loc)values('R7204135445','ALL');
