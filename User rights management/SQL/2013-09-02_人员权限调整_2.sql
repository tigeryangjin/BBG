insert into rainy_user(user_id,user_name,id) values('R7409031717','李云华','2454');

--权限变更的用户修改ID列，从BBG_Security_Application_User_List表中获取
SELECT * FROM RAINY_USER
WHERE USER_ID= 'R7409031717' FOR UPDATE;
...
SELECT 'revoke ' || rr.role_ext || ' from ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 2454 AND 2454;
...
where  RU.ID BETWEEN 2454 AND 2454 ;
...
DELETE FROM RSM_USER_ROLE T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2454 AND 2454);
DELETE FROM SEC_USER_GROUP T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2454 AND 2454);
DELETE FROM RAINY_USER_LOC T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2454 AND 2454);
DELETE FROM RAINY_USER_MERCH T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2454 AND 2454);
DELETE FROM RAINY_USER_POSITION T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2454 AND 2454);


insert into rainy_user_position(user_id,position_id) values('R7409031717',61);


insert into rainy_user_merch(user_id,merch) values('R7409031717','ALL');

insert into rainy_user_loc (user_id,loc)values('R7409031717','118001');
insert into rainy_user_loc (user_id,loc)values('R7409031717','118005');
insert into rainy_user_loc (user_id,loc)values('R7409031717','118004');
insert into rainy_user_loc (user_id,loc)values('R7409031717','118010');
insert into rainy_user_loc (user_id,loc)values('R7409031717','118011');
insert into rainy_user_loc (user_id,loc)values('R7409031717','118012');
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 2454 AND 2454
