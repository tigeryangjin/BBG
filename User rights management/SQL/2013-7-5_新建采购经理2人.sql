insert into rainy_user(user_id,user_name,id) values('R6903290427','周小铃','938');
insert into rainy_user(user_id,user_name,id) values('R8110246488','刘静','939');
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID IN('R6903290427','R8110246488') ;



insert into rainy_user_position(user_id,position_id) values('R6903290427',116);
insert into rainy_user_position(user_id,position_id) values('R8110246488',6);

insert into rainy_user_merch(user_id,merch) values('R6903290427','29');
insert into rainy_user_merch(user_id,merch) values('R8110246488','12');
insert into rainy_user_merch(user_id,merch) values('R8110246488','13');
insert into rainy_user_merch(user_id,merch) values('R8110246488','14');
insert into rainy_user_merch(user_id,merch) values('R8110246488','15');

insert into rainy_user_loc (user_id,loc)values('R6903290427','ALL');
insert into rainy_user_loc (user_id,loc)values('R8110246488','ALL');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.USER_ID IN ('R6903290427','R8110246488');
...
from rainy_user 
where  to_number (id ) between 938 and 939
...
where  RU.USER_ID IN ('R6903290427','R8110246488');
