--insert into rainy_user(user_id,user_name,id) values('R6902180557','马义鹏','974');
insert into rainy_user(user_id,user_name,id) values('R8910199209','杨艳华','975');
insert into rainy_user(user_id,user_name,id) values('R8612293646','柳柏林','976');
