SELECT * FROM RAINY_USER WHERE USER_ID='R6902081553';
SELECT * FROM RAINY_USER_MERCH WHERE USER_ID='R6902081553';
SELECT * FROM RAINY_USER_LOC WHERE USER_ID='R6902081553';
SELECT * FROM RAINY_USER_POSITION WHERE USER_ID='R6902081553';
SELECT * FROM SEC_USER_GROUP WHERE USER_ID='R6902081553';

insert into rainy_user_position(user_id,position_id) values('R6902081553',68);
...
where  RU.USER_ID IN ('R6902081553' );
