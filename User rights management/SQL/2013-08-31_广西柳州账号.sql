insert into rainy_user(user_id,user_name,id) values('R8102190635','王科霖','2447');
insert into rainy_user(user_id,user_name,id) values('R810620520X','黄柳莉','2448');
...
to ' || ru.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user ru
  WHERE RU.ID BETWEEN 2447 AND 2451 ;
  
  --权限变更的用户修改ID列，从BBG_Security_Application_User_List表中获取
SELECT * FROM RAINY_USER
WHERE USER_ID IN( 'R8405301315','R830624001X','R8005202410') FOR UPDATE;
/*insert into rainy_user(user_id,user_name,id) values('R8405301315','廖劲峰','2449');
insert into rainy_user(user_id,user_name,id) values('R830624001X','韦皓','2450');
insert into rainy_user(user_id,user_name,id) values('R8005202410','钟林','2451');*/
--移除原职位权限
--查询出来的语句在sys用户下执行
SELECT 'revoke ' || rr.role_ext || ' from ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 2447 AND 2451;
...
DELETE FROM RSM_USER_ROLE T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2447 AND 2451);
DELETE FROM SEC_USER_GROUP T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2447 AND 2451);
DELETE FROM RAINY_USER_LOC T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2447 AND 2451);
DELETE FROM RAINY_USER_MERCH T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2447 AND 2451);
DELETE FROM RAINY_USER_POSITION T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2447 AND 2451);



insert into rainy_user_position(user_id,position_id) values('R8102190635',84);
insert into rainy_user_position(user_id,position_id) values('R810620520X',90);
insert into rainy_user_position(user_id,position_id) values('R8405301315',95);
insert into rainy_user_position(user_id,position_id) values('R830624001X',96);
insert into rainy_user_position(user_id,position_id) values('R8005202410',93);


insert into rainy_user_merch(user_id,merch) values('R8102190635','ALL');
insert into rainy_user_merch(user_id,merch) values('R810620520X','ALL');
...
insert into rainy_user_merch(user_id,merch) values('R8005202410','ALL');

insert into rainy_user_loc (user_id,loc)values('R8102190635','120195');
insert into rainy_user_loc (user_id,loc)values('R810620520X','120195');
insert into rainy_user_loc (user_id,loc)values('R8405301315','120195');
insert into rainy_user_loc (user_id,loc)values('R830624001X','120195');
insert into rainy_user_loc (user_id,loc)values('R8005202410','120195');
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 2447 AND 2451
