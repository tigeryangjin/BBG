insert into rainy_user(user_id,user_name,id) values('R8511243310','欧阳惺博','941');
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID='R8511243310' ;


insert into rainy_user_position(user_id,position_id) values('R8511243310',19);  
insert into rainy_user_position(user_id,position_id) values('R8511243310',20);  
insert into rainy_user_position(user_id,position_id) values('R8511243310',21);

insert into rainy_user_merch(user_id,merch) values('R8511243310','ALL');

insert into rainy_user_loc (user_id,loc)values('RR8511243310','118004');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','118010');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120043');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120044');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120073');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120084');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120088');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120092');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120111');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120127');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120138');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120148');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120152');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120174');
insert into rainy_user_loc (user_id,loc)values('RR8511243310','120180');
...
where  RU.USER_ID IN ('R8511243310' );
