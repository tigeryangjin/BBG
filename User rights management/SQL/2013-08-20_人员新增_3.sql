insert into rainy_user(user_id,user_name,id) values('R7708154822','雷玲','2173');
...
insert into rainy_user_position(user_id,position_id) values('R7708154822',84);

insert into rainy_user_merch(user_id,merch) values('R7708154822','ALL');

insert into rainy_user_loc (user_id,loc)values('R7708154822','120113');
