insert into rainy_user(user_id,user_name,id) values('R7612271515','高珺','2193');
...
insert into rainy_user_position( user_id, position_id) values('R7612271515' ,36 );

--已有工号的大类权限调整，从excel[Merchandise工作表]中复制出类似以下语句执行
insert into rainy_user_merch( user_id, merch) values( 'R7612271515' ,'ALL' );

--已有工号的地点权限调整，从excel[Organization工作表]中复制出类似以下语句执行
insert into rainy_user_loc (user_id ,loc )values ( 'R7612271515' ,'ALL' );
