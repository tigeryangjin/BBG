insert into rainy_user(user_id,user_name,id) values('R7205041544','盛勇军','1035');
--修改密码
update rainy_user t
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID='R7205041544' ;


insert into rainy_user_position(user_id,position_id) values('R7205041544',62);

insert into rainy_user_merch(user_id,merch) values('R7205041544','ALL');

insert into rainy_user_loc (user_id,loc)values('R7205041544','ALL');
...
where  RU.USER_ID IN ('R7205041544' );
