insert into rainy_user(user_id,user_name,id) values('R781027331X','丁勇','940');
--R781027331X
--修改密码
update rainy_user t
...
insert into rainy_user_position(user_id,position_id) values('R781027331X',36);
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID='R781027331X' ;
  
insert into rainy_user_merch(user_id,merch) values('R781027331X','ALL');

insert into rainy_user_loc (user_id,loc)values('R781027331X','ALL');
...
where  RU.USER_ID IN ('R781027331X' );
