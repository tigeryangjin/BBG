insert into rainy_user(user_id,user_name,id) values('R8005010838','吕超','1392');
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID='R8005010838' ;


insert into rainy_user_position(user_id,position_id) values('R8005010838',5);

insert into rainy_user_merch(user_id,merch) values('R8005010838','12');
insert into rainy_user_merch(user_id,merch) values('R8005010838','13');
insert into rainy_user_merch(user_id,merch) values('R8005010838','14');
insert into rainy_user_merch(user_id,merch) values('R8005010838','15');
insert into rainy_user_merch(user_id,merch) values('R8005010838','16');
insert into rainy_user_merch(user_id,merch) values('R8005010838','17');
insert into rainy_user_merch(user_id,merch) values('R8005010838','18');
insert into rainy_user_merch(user_id,merch) values('R8005010838','19');
insert into rainy_user_merch(user_id,merch) values('R8005010838','21');
insert into rainy_user_merch(user_id,merch) values('R8005010838','22');
insert into rainy_user_merch(user_id,merch) values('R8005010838','23');
insert into rainy_user_merch(user_id,merch) values('R8005010838','24');
insert into rainy_user_merch(user_id,merch) values('R8005010838','25');
insert into rainy_user_merch(user_id,merch) values('R8005010838','26');
insert into rainy_user_merch(user_id,merch) values('R8005010838','27');
insert into rainy_user_merch(user_id,merch) values('R8005010838','29');
insert into rainy_user_merch(user_id,merch) values('R8005010838','76');

insert into rainy_user_loc (user_id,loc)values('R8005010838','118004');
insert into rainy_user_loc (user_id,loc)values('R8005010838','118010');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120043');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120044');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120073');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120083');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120084');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120086');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120088');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120092');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120111');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120127');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120138');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120148');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120152');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120174');
insert into rainy_user_loc (user_id,loc)values('R8005010838','120180');
