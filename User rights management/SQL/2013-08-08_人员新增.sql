insert into rainy_user(user_id,user_name,id) values('R8611210061','吴君','1438');
--insert into rainy_user(user_id,user_name,id) values('R8703032819','段维','1439');
insert into rainy_user(user_id,user_name,id) values('R9005257125','周缓','1440');
insert into rainy_user(user_id,user_name,id) values('R8407294518','吴洪宇','1441');
insert into rainy_user(user_id,user_name,id) values('R8806268316','蔡道刚','1442');
insert into rainy_user(user_id,user_name,id) values('R8907206875','黄杨','1443');
insert into rainy_user(user_id,user_name,id) values('R8803064152','叶世锋','1444');
insert into rainy_user(user_id,user_name,id) values('R8904134118','谭斯斯','1445');
insert into rainy_user(user_id,user_name,id) values('R8312292376','谢文刚','1446');
insert into rainy_user(user_id,user_name,id) values('R8304160026','徐玲萍','1447');

--权限变更的用户修改ID列，从BBG_Security_Application_User_List表中获取
SELECT * FROM RAINY_USER
WHERE USER_ID= 'R8703032819' FOR UPDATE;
...
to ' || ru.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user ru
  WHERE RU.ID BETWEEN 1438 AND 1447 ;
...
DELETE FROM RSM_USER_ROLE T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID =1439);
DELETE FROM SEC_USER_GROUP T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID =1439);
DELETE FROM RAINY_USER_LOC T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID =1439);
DELETE FROM RAINY_USER_MERCH T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID =1439);
DELETE FROM RAINY_USER_POSITION T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID =1439);




insert into rainy_user_position(user_id,position_id) values('R8611210061',2);
insert into rainy_user_position(user_id,position_id) values('R8611210061',86);
insert into rainy_user_position(user_id,position_id) values('R8703032819',3);
insert into rainy_user_position(user_id,position_id) values('R8703032819',86);
insert into rainy_user_position(user_id,position_id) values('R9005257125',86);
insert into rainy_user_position(user_id,position_id) values('R8407294518',86);
insert into rainy_user_position(user_id,position_id) values('R8806268316',86);
insert into rainy_user_position(user_id,position_id) values('R8907206875',86);
insert into rainy_user_position(user_id,position_id) values('R8803064152',86);
insert into rainy_user_position(user_id,position_id) values('R8904134118',86);
insert into rainy_user_position(user_id,position_id) values('R8312292376',88);
insert into rainy_user_position(user_id,position_id) values('R8304160026',61);



insert into rainy_user_merch(user_id,merch) values('R8611210061','29');
insert into rainy_user_merch(user_id,merch) values('R8703032819','32');
insert into rainy_user_merch(user_id,merch) values('R8703032819','35');
insert into rainy_user_merch(user_id,merch) values('R8703032819','42');
insert into rainy_user_merch(user_id,merch) values('R9005257125','16');
insert into rainy_user_merch(user_id,merch) values('R9005257125','17');
insert into rainy_user_merch(user_id,merch) values('R9005257125','18');
insert into rainy_user_merch(user_id,merch) values('R9005257125','19');
insert into rainy_user_merch(user_id,merch) values('R8407294518','36');
insert into rainy_user_merch(user_id,merch) values('R8407294518','37');
insert into rainy_user_merch(user_id,merch) values('R8806268316','25');
insert into rainy_user_merch(user_id,merch) values('R8806268316','26');
insert into rainy_user_merch(user_id,merch) values('R8907206875','11');
insert into rainy_user_merch(user_id,merch) values('R8907206875','12');
insert into rainy_user_merch(user_id,merch) values('R8907206875','13');
insert into rainy_user_merch(user_id,merch) values('R8907206875','14');
insert into rainy_user_merch(user_id,merch) values('R8907206875','15');
insert into rainy_user_merch(user_id,merch) values('R8803064152','27');
insert into rainy_user_merch(user_id,merch) values('R8803064152','33');
insert into rainy_user_merch(user_id,merch) values('R8803064152','38');
insert into rainy_user_merch(user_id,merch) values('R8904134118','21');
insert into rainy_user_merch(user_id,merch) values('R8904134118','22');
insert into rainy_user_merch(user_id,merch) values('R8904134118','23');
insert into rainy_user_merch(user_id,merch) values('R8904134118','24');
insert into rainy_user_merch(user_id,merch) values('R8312292376','ALL');
insert into rainy_user_merch(user_id,merch) values('R8304160026','ALL');


insert into rainy_user_loc (user_id,loc)values('R8611210061','120194');
insert into rainy_user_loc (user_id,loc)values('R8703032819','120194');
insert into rainy_user_loc (user_id,loc)values('R9005257125','120194');
insert into rainy_user_loc (user_id,loc)values('R8407294518','120194');
insert into rainy_user_loc (user_id,loc)values('R8806268316','120194');
insert into rainy_user_loc (user_id,loc)values('R8907206875','120194');
insert into rainy_user_loc (user_id,loc)values('R8803064152','120194');
insert into rainy_user_loc (user_id,loc)values('R8904134118','120194');
insert into rainy_user_loc (user_id,loc)values('R8312292376','120194');
insert into rainy_user_loc (user_id,loc)values('R8304160026','ALL');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND rup.position_id = rpr.position_id
   AND rpr.role_id = rr.role_id
   AND RU.ID BETWEEN 1438 AND 1447;
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 1438 AND 1447
