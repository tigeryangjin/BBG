SELECT * FROM RAINY_USER RU
WHERE EXISTS(SELECT 1 FROM RAINY_USER_POSITION RUP WHERE RU.USER_ID=RUP.USER_ID AND RUP.POSITION_ID=127);

SELECT * FROM RAINY_POSITION WHERE POSITION_ID=127

SELECT * FROM RAINY_POSITION_ROLE WHERE POSITION_ID=127
关闭的:
1	R9408242584	罗诗语	BPzlu891	1385
2	R9408242605	罗诗琴	TAnub313	1386
3	R9301062559	方宇星	WXylm367	1387
4	R9209285677	姚邵锋	KYbzf693	1388
9	R9907137088	陈丽	YZtir511	1425
7	R9408092088	陈亦乔	QDrhe774	1391
12	R970429205X	滕昭雨	QEage419	1428

insert into rainy_user(user_id,user_name,id) values('R9110026587','蒙思雨','2425');
insert into rainy_user(user_id,user_name,id) values('R8501301588','陈义','2426');
insert into rainy_user(user_id,user_name,id) values('R9012027050','郑骅','2427');
insert into rainy_user(user_id,user_name,id) values('R9205226988','周冰香','2428');
insert into rainy_user(user_id,user_name,id) values('R9109101027','张湘宁','2429');
insert into rainy_user(user_id,user_name,id) values('R910921054X','莫莉','2430');
...
to ' || ru.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user ru
  WHERE RU.ID BETWEEN 2425 AND 2430 ;


insert into rainy_user_position(user_id,position_id) values('R9110026587',127);
insert into rainy_user_position(user_id,position_id) values('R8501301588',127);
insert into rainy_user_position(user_id,position_id) values('R9012027050',127);
insert into rainy_user_position(user_id,position_id) values('R9205226988',127);
insert into rainy_user_position(user_id,position_id) values('R9109101027',127);
insert into rainy_user_position(user_id,position_id) values('R910921054X',127);

insert into rainy_user_merch(user_id,merch) values('R9110026587','ALL');
insert into rainy_user_merch(user_id,merch) values('R8501301588','ALL');
insert into rainy_user_merch(user_id,merch) values('R9012027050','ALL');
insert into rainy_user_merch(user_id,merch) values('R9205226988','ALL');
insert into rainy_user_merch(user_id,merch) values('R9109101027','ALL');
insert into rainy_user_merch(user_id,merch) values('R910921054X','ALL');

insert into rainy_user_loc (user_id,loc)values('R9110026587','ALL');
insert into rainy_user_loc (user_id,loc)values('R8501301588','ALL');
insert into rainy_user_loc (user_id,loc)values('R9012027050','ALL');
insert into rainy_user_loc (user_id,loc)values('R9205226988','ALL');
insert into rainy_user_loc (user_id,loc)values('R9109101027','ALL');
insert into rainy_user_loc (user_id,loc)values('R910921054X','ALL');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 2425 AND 2430;
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 2425 AND 2430
