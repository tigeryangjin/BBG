insert into rainy_user(user_id,user_name,id) values('R880430171X','张可','970');
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID='R880430171X' ;
  
--  
insert into rainy_user_position(user_id,position_id) values('R880430171X',20);
--
insert into rainy_user_merch(user_id,merch) values('R880430171X','ALL');
--
insert into rainy_user_loc (user_id,loc)values('R880430171X','ALL');
...
where  RU.USER_ID IN ('R880430171X' );
