insert into rainy_user(user_id,user_name,id) values('R8411102610','孙振球','2149');
--insert into rainy_user(user_id,user_name,id) values('R7411170425','夏海燕','2150');
--insert into rainy_user(user_id,user_name,id) values('R7801281559','皮毅','2151');
--insert into rainy_user(user_id,user_name,id) values('R7705200559','彭峰','2152');
--insert into rainy_user(user_id,user_name,id) values('R7112073021','邓灿炬','2153');
--insert into rainy_user(user_id,user_name,id) values('R7909221822','邓小芬','2154');
--insert into rainy_user(user_id,user_name,id) values('R7203227210','曾建红','2155');
insert into rainy_user(user_id,user_name,id) values('R7004151022','刘顺娥','2156');
--insert into rainy_user(user_id,user_name,id) values('R7409254965','范彩','2157');
--insert into rainy_user(user_id,user_name,id) values('R7002270031','朱国民','2158');
