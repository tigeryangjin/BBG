insert into rainy_user(user_id,user_name,id) values('R891027786X','徐曦','2226');
...
insert into rainy_user_position(user_id,position_id) values('R891027786X',86);

insert into rainy_user_merch(user_id,merch) values('R891027786X','12');  
insert into rainy_user_merch(user_id,merch) values('R891027786X','13');	
insert into rainy_user_merch(user_id,merch) values('R891027786X','14');	
insert into rainy_user_merch(user_id,merch) values('R891027786X','15');

insert into rainy_user_loc (user_id,loc)values('R891027786X','120153');
insert into rainy_user_loc (user_id,loc)values('R891027786X','118001');
