insert into rainy_user(user_id,user_name,id) values('R7701080244','姚水英','953');
insert into rainy_user(user_id,user_name,id) values('R7708031513','唐谟军','954');
insert into rainy_user(user_id,user_name,id) values('R1760705002','汤源江','955');
--insert into rainy_user(user_id,user_name,id) values('R4670225005','谢持安','956');
insert into rainy_user(user_id,user_name,id) values('R770223004X','李少梅','957');
insert into rainy_user(user_id,user_name,id) values('R7608050462','毛敏洪','958');

--权限变更的用户修改ID列，从BBG_Security_Application_User_List表中获取
SELECT * FROM RAINY_USER
WHERE USER_ID= 'R4670225005' FOR UPDATE

--删除原网点
DELETE FROM RAINY_USER_LOC WHERE USER_ID IN ('R4670225005' );
--SELECT * FROM RAINY_USER_LOC WHERE USER_ID IN ('R4670225005' );
DELETE FROM SEC_USER_GROUP 
WHERE USER_ID IN ('R7701080244','R7708031513','R1760705002','R4670225005','R770223004X','R7608050462' );
--修改密码
update rainy_user t
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID IN ('R7701080244','R7708031513','R1760705002','R770223004X','R7608050462') ;
  
--
insert into rainy_user_position(user_id,position_id) values('R7701080244',62);
insert into rainy_user_position(user_id,position_id) values('R7708031513',64);
insert into rainy_user_position(user_id,position_id) values('R7708031513',96);
insert into rainy_user_position(user_id,position_id) values('R1760705002',64);
--insert into rainy_user_position(user_id,position_id) values('R4670225005',64);
insert into rainy_user_position(user_id,position_id) values('R770223004X',62);
insert into rainy_user_position(user_id,position_id) values('R7608050462',62);
--
insert into rainy_user_merch(user_id,merch) values('R7701080244','ALL');
insert into rainy_user_merch(user_id,merch) values('R7708031513','ALL');
insert into rainy_user_merch(user_id,merch) values('R1760705002','ALL');
--insert into rainy_user_merch(user_id,merch) values('R4670225005','ALL');
insert into rainy_user_merch(user_id,merch) values('R770223004X','ALL');
insert into rainy_user_merch(user_id,merch) values('R7608050462','ALL');
--
insert into rainy_user_loc (user_id,loc)values('R7701080244','ALL');
insert into rainy_user_loc (user_id,loc)values('R7708031513','ALL');
insert into rainy_user_loc (user_id,loc)values('R1760705002','ALL');
insert into rainy_user_loc (user_id,loc)values('R4670225005','ALL');
insert into rainy_user_loc (user_id,loc)values('R770223004X','ALL');
insert into rainy_user_loc (user_id,loc)values('R7608050462','ALL');
---
--添加新职位权限
--RMS系统权限
--查询出来的数据用sys用户名执行
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.USER_ID IN ('R7701080244','R7708031513','R1760705002','R770223004X','R7608050462' );
...
from rainy_user 
where  USER_ID IN ('R7701080244','R7708031513','R1760705002','R770223004X','R7608050462' )
...
INSERT INTO sec_user_group
  SELECT sg.group_id , ru.user_id
   ...
   WHERE ru.user_id = rul.user_id
     ...
     AND RU.USER_ID IN ('R7701080244','R7708031513','R1760705002','R4670225005','R770223004X','R7608050462' );
--Department大类    
INSERT INTO sec_user_group
  SELECT sg.group_id , ru.user_id
...
where  RU.USER_ID IN ('R8209171564' ,'R8801150566' ,'R7711102104' );
...
where  RU.USER_ID IN ('R4670225005' ) ;
