SELECT * FROM RAINY_USER WHERE USER_ID IN ('R8511120772','R7909210724') FOR UPDATE;
--DELETE RAINY_USER WHERE ID=908;
insert into rainy_user(user_id,user_name,id) values('R8912311524','邓紫薇','907');
--insert into rainy_user(user_id,user_name,id) values('R90021162X','黄谦','908');
insert into rainy_user(user_id,user_name,id) values('R8307102528','吴海霞','909');
insert into rainy_user(user_id,user_name,id) values('R8702114487','刘韦','910');
insert into rainy_user(user_id,user_name,id) values('R7710300620','冯燕','911');
insert into rainy_user(user_id,user_name,id) values('R8207020018','徐嵩涛','912');
insert into rainy_user(user_id,user_name,id) values('R8805290440','邹宇','913');
insert into rainy_user(user_id,user_name,id) values('R8501133867','杨治娟','914');
insert into rainy_user(user_id,user_name,id) values('R8506193420','徐静','915');
insert into rainy_user(user_id,user_name,id) values('R8803301547','邱迷媚','916');
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.ID BETWEEN 907 AND 916 ;
...
SELECT 'revoke ' || rr.role_ext || ' from ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID IN (906,917 );
   
    --删除表中用户数据，权限清除后需要删除的表
DELETE FROM RSM_USER_ROLE WHERE user_id IN ('R8511120772','R7909210724');
DELETE FROM SEC_USER_GROUP WHERE USER_ID IN ('R8511120772','R7909210724');
DELETE FROM RAINY_USER_LOC WHERE USER_ID IN ('R8511120772','R7909210724');
DELETE FROM RAINY_USER_MERCH WHERE USER_ID IN ('R8511120772','R7909210724');
DELETE FROM RAINY_USER_POSITION WHERE USER_ID IN ('R8511120772','R7909210724');

   --职位
insert into rainy_user_position(user_id,position_id)values('R8511120772',6);
insert into rainy_user_position(user_id,position_id)values('R8912311524',11);
insert into rainy_user_position(user_id,position_id)values('R8307102528',5);
insert into rainy_user_position(user_id,position_id)values('R8702114487',5);
insert into rainy_user_position(user_id,position_id)values('R7710300620',10);
insert into rainy_user_position(user_id,position_id)values('R8207020018',11);
insert into rainy_user_position(user_id,position_id)values('R8805290440',7);
insert into rainy_user_position(user_id,position_id)values('R8501133867',7);
insert into rainy_user_position(user_id,position_id)values('R8506193420',7);
insert into rainy_user_position(user_id,position_id)values('R8803301547',30);
insert into rainy_user_position(user_id,position_id)values('R7909210724',10);

--大类
insert into rainy_user_merch(user_id,merch) values('R8511120772','23');
insert into rainy_user_merch(user_id,merch) values('R8912311524','33');
insert into rainy_user_merch(user_id,merch) values('R8912311524','36');
insert into rainy_user_merch(user_id,merch) values('R8912311524','37');
insert into rainy_user_merch(user_id,merch) values('R8307102528','16');
insert into rainy_user_merch(user_id,merch) values('R8307102528','17');
insert into rainy_user_merch(user_id,merch) values('R8702114487','18');
insert into rainy_user_merch(user_id,merch) values('R8702114487','19');
insert into rainy_user_merch(user_id,merch) values('R7710300620','27');
insert into rainy_user_merch(user_id,merch) values('R7710300620','38');
insert into rainy_user_merch(user_id,merch) values('R8207020018','33');
insert into rainy_user_merch(user_id,merch) values('R8207020018','36');
insert into rainy_user_merch(user_id,merch) values('R8207020018','37');
insert into rainy_user_merch(user_id,merch) values('R8805290440','16');
insert into rainy_user_merch(user_id,merch) values('R8805290440','17');
insert into rainy_user_merch(user_id,merch) values('R8805290440','18');
insert into rainy_user_merch(user_id,merch) values('R8805290440','19');
insert into rainy_user_merch(user_id,merch) values('R8501133867','29');
insert into rainy_user_merch(user_id,merch) values('R8506193420','29');
insert into rainy_user_merch(user_id,merch) values('R8803301547','ALL');
insert into rainy_user_merch(user_id,merch) values('R7909210724','32');
insert into rainy_user_merch(user_id,merch) values('R7909210724','33');
insert into rainy_user_merch(user_id,merch) values('R7909210724','35');
insert into rainy_user_merch(user_id,merch) values('R7909210724','36');
insert into rainy_user_merch(user_id,merch) values('R7909210724','37');
insert into rainy_user_merch(user_id,merch) values('R7909210724','42');

--地点
insert into rainy_user_loc (user_id,loc)values('R8511120772','ALL');
insert into rainy_user_loc (user_id,loc)values('R8912311524','ALL');
insert into rainy_user_loc (user_id,loc)values('R8307102528','120194');
insert into rainy_user_loc (user_id,loc)values('R8702114487','120194');
insert into rainy_user_loc (user_id,loc)values('R7710300620','120194');
insert into rainy_user_loc (user_id,loc)values('R8207020018','120194');
insert into rainy_user_loc (user_id,loc)values('R8805290440','120194');
insert into rainy_user_loc (user_id,loc)values('R8501133867','120194');
insert into rainy_user_loc (user_id,loc)values('R8506193420','120194');
insert into rainy_user_loc (user_id,loc)values('R8803301547','120194');
insert into rainy_user_loc (user_id,loc)values('R7909210724','120194');
...
from rainy_user 
where  to_number (id ) BETWEEN 907 AND 916
...
where  to_number( ru.id) between 906 AND 917   ;
