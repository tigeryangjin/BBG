--insert into rainy_user(user_id,user_name,id) values('R8608160612','马丕江','2418');
--insert into rainy_user(user_id,user_name,id) values('R7902258511','马勇','2419');
insert into rainy_user(user_id,user_name,id) values('R8912274537','李曾','2420');
--insert into rainy_user(user_id,user_name,id) values('R7702036768','陶小平','2421');
--insert into rainy_user(user_id,user_name,id) values('R8101231440','余细燕','2422');
--insert into rainy_user(user_id,user_name,id) values('R8207144811','卜鹏程','2423');
--insert into rainy_user(user_id,user_name,id) values('R8010130010','易平','2424');
...
WHERE USER_ID in( 'R8608160612','R7902258511','R7702036768','R8101231440','R8207144811','R8010130010') FOR UPDATE;
...
SELECT 'revoke ' || rr.role_ext || ' from ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 2418 AND 2424;
...
where  RU.ID BETWEEN 2418 AND 2424 ;
...
DELETE FROM RSM_USER_ROLE T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2418 AND 2424);
DELETE FROM SEC_USER_GROUP T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2418 AND 2424);
DELETE FROM RAINY_USER_LOC T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2418 AND 2424);
DELETE FROM RAINY_USER_MERCH T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2418 AND 2424);
DELETE FROM RAINY_USER_POSITION T WHERE EXISTS(SELECT 1 FROM RAINY_USER RU WHERE T.USER_ID=RU.USER_ID AND RU.ID BETWEEN 2418 AND 2424);
...
insert into rainy_user_position(user_id,position_id) values('R8912274537',95);
...
-----------------------------------------------------------------------------
insert into rainy_user_merch(user_id,merch) values('R8608160612','27');
insert into rainy_user_merch(user_id,merch) values('R8608160612','33');
...
insert into rainy_user_merch(user_id,merch) values('R8608160612','38');
insert into rainy_user_merch(user_id,merch) values('R8608160612','41');
insert into rainy_user_merch(user_id,merch) values('R7902258511','27');
...
insert into rainy_user_merch(user_id,merch) values('R8912274537','12');
insert into rainy_user_merch(user_id,merch) values('R8912274537','13');
insert into rainy_user_merch(user_id,merch) values('R8912274537','14');
insert into rainy_user_merch(user_id,merch) values('R8912274537','15');
insert into rainy_user_merch(user_id,merch) values('R8912274537','16');
insert into rainy_user_merch(user_id,merch) values('R8912274537','17');
insert into rainy_user_merch(user_id,merch) values('R8912274537','18');
insert into rainy_user_merch(user_id,merch) values('R8912274537','19');
insert into rainy_user_merch(user_id,merch) values('R8912274537','21');
insert into rainy_user_merch(user_id,merch) values('R8912274537','22');
insert into rainy_user_merch(user_id,merch) values('R8912274537','23');
insert into rainy_user_merch(user_id,merch) values('R8912274537','24');
insert into rainy_user_merch(user_id,merch) values('R8912274537','25');
insert into rainy_user_merch(user_id,merch) values('R8912274537','26');
insert into rainy_user_merch(user_id,merch) values('R8912274537','27');
insert into rainy_user_merch(user_id,merch) values('R8912274537','29');
insert into rainy_user_merch(user_id,merch) values('R8912274537','30');
insert into rainy_user_merch(user_id,merch) values('R8912274537','31');
insert into rainy_user_merch(user_id,merch) values('R8912274537','32');
insert into rainy_user_merch(user_id,merch) values('R8912274537','33');
insert into rainy_user_merch(user_id,merch) values('R8912274537','34');
insert into rainy_user_merch(user_id,merch) values('R8912274537','35');
insert into rainy_user_merch(user_id,merch) values('R8912274537','36');
insert into rainy_user_merch(user_id,merch) values('R8912274537','37');
insert into rainy_user_merch(user_id,merch) values('R8912274537','38');
insert into rainy_user_merch(user_id,merch) values('R8912274537','39');
insert into rainy_user_merch(user_id,merch) values('R8912274537','40');
insert into rainy_user_merch(user_id,merch) values('R8912274537','41');
insert into rainy_user_merch(user_id,merch) values('R8912274537','42');
insert into rainy_user_merch(user_id,merch) values('R8912274537','71');
insert into rainy_user_merch(user_id,merch) values('R8912274537','72');
insert into rainy_user_merch(user_id,merch) values('R8912274537','73');
insert into rainy_user_merch(user_id,merch) values('R8912274537','74');
insert into rainy_user_merch(user_id,merch) values('R8912274537','75');
insert into rainy_user_merch(user_id,merch) values('R8912274537','76');
insert into rainy_user_merch(user_id,merch) values('R8912274537','77');
insert into rainy_user_merch(user_id,merch) values('R8912274537','78');
insert into rainy_user_merch(user_id,merch) values('R8912274537','99');
...
insert into rainy_user_merch(user_id,merch) values('R7702036768','29');
...
insert into rainy_user_merch(user_id,merch) values('R8207144811','42');
...
insert into rainy_user_merch(user_id,merch) values('R8010130010','25');
insert into rainy_user_merch(user_id,merch) values('R8010130010','26');
---------------------------------------------------------------------
...
insert into rainy_user_loc (user_id,loc)values('R8912274537','120157');
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 2418 AND 2424
