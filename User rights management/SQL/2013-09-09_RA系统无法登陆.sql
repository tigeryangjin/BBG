SELECT * FROM RAINY_USER RU WHERE RU.USER_ID='R7201230011';

SELECT * FROM RAINY_USER          WHERE USER_ID= 'R7201230011';
SELECT * FROM RAINY_USER_POSITION  WHERE USER_ID= 'R7201230011';
SELECT * FROM RAINY_USER_MERCH    WHERE USER_ID= 'R7201230011';
SELECT * FROM RAINY_USER_LOC      WHERE USER_ID= 'R7201230011';


--查看某一岗位的权限明细
SELECT * FROM RAINY_ROLE RR
WHERE EXISTS (SELECT 1 FROM RAINY_POSITION_ROLE RPR WHERE RR.ROLE_ID = RPR.ROLE_ID AND RPR.POSITION_ID=84 );
