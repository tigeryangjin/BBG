insert into rainy_user(user_id,user_name,id) values('R8309055725','肖莉','2143');
insert into rainy_user(user_id,user_name,id) values('R6704071521','黄永红','2144');
insert into rainy_user(user_id,user_name,id) values('R7908080017','蒋简飞','2145');
insert into rainy_user(user_id,user_name,id) values('R7706304882','张中芳','2146');
insert into rainy_user(user_id,user_name,id) values('R7506185727','周君','2147');
insert into rainy_user(user_id,user_name,id) values('R8704280095','欧文军','2148');
...
to ' || ru.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user ru
  WHERE RU.ID BETWEEN 2143 AND 2148 ;
  
  
insert into rainy_user_position(user_id,position_id) values('R8309055725',86);
insert into rainy_user_position(user_id,position_id) values('R6704071521',86);
insert into rainy_user_position(user_id,position_id) values('R7908080017',86);
insert into rainy_user_position(user_id,position_id) values('R7706304882',87);
insert into rainy_user_position(user_id,position_id) values('R7506185727',87);
insert into rainy_user_position(user_id,position_id) values('R8704280095',75);
------------------------------------------------------------------------------
insert into rainy_user_merch(user_id,merch) values('R8309055725','36');
insert into rainy_user_merch(user_id,merch) values('R8309055725','37');
insert into rainy_user_merch(user_id,merch) values('R8309055725','41');
insert into rainy_user_merch(user_id,merch) values('R6704071521','27');
insert into rainy_user_merch(user_id,merch) values('R6704071521','29');
insert into rainy_user_merch(user_id,merch) values('R6704071521','31');
insert into rainy_user_merch(user_id,merch) values('R6704071521','33');
insert into rainy_user_merch(user_id,merch) values('R6704071521','34');
insert into rainy_user_merch(user_id,merch) values('R6704071521','38');
insert into rainy_user_merch(user_id,merch) values('R6704071521','39');
insert into rainy_user_merch(user_id,merch) values('R6704071521','40');
insert into rainy_user_merch(user_id,merch) values('R7908080017','32');
insert into rainy_user_merch(user_id,merch) values('R7908080017','35');
insert into rainy_user_merch(user_id,merch) values('R7908080017','40');
insert into rainy_user_merch(user_id,merch) values('R7908080017','42');
insert into rainy_user_merch(user_id,merch) values('R7706304882','31');
insert into rainy_user_merch(user_id,merch) values('R7706304882','34');
insert into rainy_user_merch(user_id,merch) values('R7706304882','39');
insert into rainy_user_merch(user_id,merch) values('R7506185727','31');
insert into rainy_user_merch(user_id,merch) values('R8704280095','21');
insert into rainy_user_merch(user_id,merch) values('R8704280095','22');
-----------------------------------------------------------------------
insert into rainy_user_loc (user_id,loc)values('R8309055725','120170');
insert into rainy_user_loc (user_id,loc)values('R6704071521','120170');
insert into rainy_user_loc (user_id,loc)values('R7908080017','120170');
insert into rainy_user_loc (user_id,loc)values('R7706304882','120170');
insert into rainy_user_loc (user_id,loc)values('R7506185727','120170');
insert into rainy_user_loc (user_id,loc)values('R8704280095','120194');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.ID BETWEEN 2143 AND 2148;
...
from rainy_user ru
where  to_number (RU.id ) BETWEEN 2143 AND 2148
