--有三人权限调整：其中郭永红是岗位增加需权限维护，刘彩虹是新增人员，钟萍7512205328已离司需关闭权限。
--R7512205328离职
--R7610241444新建
--R8210267147增加岗位
SELECT * FROM RAINY_USER WHERE USER_ID='R8210267147' FOR UPDATE;

insert into rainy_user(user_id,user_name,id) values('R7610241444','刘彩红','937');
...
SELECT 'revoke ' || rr.role_ext || ' from ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.USER_ID IN ( 'R7512205328','R8210267147');
   
--删除表中用户数据，权限清除后需要删除的表
DELETE FROM RSM_USER_ROLE WHERE user_id IN ('R7512205328','R8210267147');
DELETE FROM SEC_USER_GROUP WHERE USER_ID IN ('R7512205328','R8210267147');
DELETE FROM RAINY_USER_LOC WHERE USER_ID IN ('R7512205328','R8210267147');
DELETE FROM RAINY_USER_MERCH WHERE USER_ID IN ('R7512205328','R8210267147' );
DELETE FROM RAINY_USER_POSITION WHERE USER_ID IN ('R7512205328','R8210267147' );
--
insert into rainy_user_position(user_id,position_id) values('R8210267147',20);
insert into rainy_user_position(user_id,position_id) values('R8210267147',29);
insert into rainy_user_position(user_id,position_id) values('R8210267147',34);
insert into rainy_user_position(user_id,position_id) values('R8210267147',35);
insert into rainy_user_position(user_id,position_id) values('R8210267147',43);
insert into rainy_user_position(user_id,position_id) values('R8210267147',46);
insert into rainy_user_position(user_id,position_id) values('R8210267147',56);
insert into rainy_user_position(user_id,position_id) values('R7610241444',80);
--
insert into rainy_user_merch(user_id,merch) values('R8210267147','ALL');
insert into rainy_user_merch(user_id,merch) values('R7610241444','12');
insert into rainy_user_merch(user_id,merch) values('R7610241444','13');
insert into rainy_user_merch(user_id,merch) values('R7610241444','14');
insert into rainy_user_merch(user_id,merch) values('R7610241444','15');

--
insert into rainy_user_loc (user_id,loc)values('R8210267147','118004');
insert into rainy_user_loc (user_id,loc)values('R8210267147','118010');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120043');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120044');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120073');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120084');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120088');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120092');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120111');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120127');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120138');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120148');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120152');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120174');
insert into rainy_user_loc (user_id,loc)values('R8210267147','120180');
insert into rainy_user_loc (user_id,loc)values('R7610241444','120192');
...
where  RU.USER_ID IN ('R7610241444', 'R8210267147');
