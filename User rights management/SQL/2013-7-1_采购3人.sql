--
insert into rainy_user(user_id,user_name,id) values('R8909243916','祝海军','933');
insert into rainy_user(user_id,user_name,id) values('R8905040012','刘蓝天','934');
insert into rainy_user(user_id,user_name,id) values('R8110132628','王蔚蔚','935');
--修改密码
update rainy_user t
...
to ' || rs.user_id || ' ;' || chr ( 13 ) ||
  ...
  FROM rainy_user rs
  WHERE RS.USER_ID IN ('R8909243916','R8905040012','R8110132628') ;
  
--
insert into rainy_user_position(user_id,position_id) values('R8909243916',7);
insert into rainy_user_position(user_id,position_id) values('R8905040012',7);
insert into rainy_user_position(user_id,position_id) values('R8110132628',7);
--
insert into rainy_user_merch(user_id,merch) values('R8909243916','14');
insert into rainy_user_merch(user_id,merch) values('R8909243916','15');
insert into rainy_user_merch(user_id,merch) values('R8905040012','12');
insert into rainy_user_merch(user_id,merch) values('R8905040012','13');
insert into rainy_user_merch(user_id,merch) values('R8110132628','14');
insert into rainy_user_merch(user_id,merch) values('R8110132628','15');
--
insert into rainy_user_loc (user_id,loc)values('R8909243916','ALL');
insert into rainy_user_loc (user_id,loc)values('R8905040012','ALL');
insert into rainy_user_loc (user_id,loc)values('R8110132628','ALL');
...
SELECT 'grant ' || rr.role_ext || ' to ' || ru.user_id || ';'
 ...
 WHERE rr.appl = 'RMS'
   ...
   AND RU.USER_ID IN ('R8909243916','R8905040012','R8110132628');
...
from rainy_user 
where  USER_ID IN ('R8909243916','R8905040012','R8110132628')
...
where  RU.USER_ID IN ('R8909243916','R8905040012','R8110132628');
