...
SELECT ORG.ORG_NUM 门店编码,
			 ORG_NAME.ORG_NAME 门店名称,
			 DH.LVL4ANC_PRODCAT_ID 类别编码,
			 D2.C1 类别名称,
			 PROD_NUM.PROD_NUM 商品编码,
			 PROD_NAME.PRODUCT_NAME 商品名称,
			 NOWINV.INV_SOH_QTY 库存数量,
			 NOWINV.INV_SOH_COST_AMT_LCL 库存成本
	FROM --INV
...
--网点名称
 ...
 WHERE INV.PROD_WID = PROD_NUM.ROW_WID
	 ...
	 AND NOWINV.DT_WID = '120131231000'
