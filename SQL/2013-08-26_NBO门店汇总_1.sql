[2013-08-26T15:25:50.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-0] [] [ecid: 0000K2tWvDhComWFLzYROA1I6e_Q000QjK] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] ############################################## [[
...
SET VARIABLE QUERY_SRC_CD='Report',SAW_SRC_PATH='/users/raadmin/YJ/NBOéšåºæ±æ»_ch';SELECT
   ...
   "Retail As-Was"."Sales"."Net Sales Qty" s_7,
   FILTER("Retail As-Was"."Last Inventory Position"."INV_ON_ORD_QTY" USING ("Retail As-Was"."BBG Item Loc"."BBG NBO Flag" ='Y')) s_8,
   FILTER("Retail As-Was"."Last Inventory Position"."INV_SOH_QTY" USING ("Retail As-Was"."BBG Item Loc"."BBG NBO Flag" ='Y')) s_9
FROM "Retail As-Was"
WHERE
...
[2013-08-26T15:25:50.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-23] [] [ecid: 0000K2tWvDhComWFLzYROA1I6e_Q000QjK] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- General Query Info: [[
Repository: Star, Subject Area: RA, Presentation: Retail As-Was

]]
[2013-08-26T15:25:50.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-18] [] [ecid: 0000K2tWvDhComWFLzYROA1I6e_Q000QjK] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Sending query to database named BBG_ANALIZE (id: <<1802067>>), connection pool named Oracle Data Warehouse Connection Pool, logical request hash d157cc34, physical request hash 86f8e356: [[
...
[2013-08-26T15:25:50.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-18] [] [ecid: 0000K2tWvDhComWFLzYROA1I6e_Q000QjK] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Sending query to database named BBG_ANALIZE (id: <<1802332>>), connection pool named Oracle Data Warehouse Connection Pool, logical request hash d157cc34, physical request hash a469c3bc: [[
...
[2013-08-26T15:25:50.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-18] [] [ecid: 0000K2tWvDhComWFLzYROA1I6e_Q000QjK] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Sending query to database named BBG_ANALIZE (id: <<1802554>>), connection pool named Oracle Data Warehouse Connection Pool, logical request hash d157cc34, physical request hash 1aee554b: [[

select concat(concat(cast(cast(T964463.ORG_NUM as  INTEGER  ) as  VARCHAR ( 20 ) ), '-'), T953980.ORG_NAME) as c1,
     concat(concat(T964333.ORG_HIER13_NUM, '~'), 'CHAIN') as c2,
     sum(nvl(T961218.SLS_QTY , 0) - nvl(T961218.RET_QTY , 0)) as c3,
     cast(T964333.ORG_HIER13_NUM as  INTEGER  ) as c4,
     concat(cast(cast(T964333.ORG_HIER13_NUM as  INTEGER  ) as  VARCHAR ( 20 ) ), '-') as c5,
...
where  ( T953980.DATASOURCE_NUM_ID = T964463.DATASOURCE_NUM_ID and T953980.INTEGRATION_ID = T964463.INTEGRATION_ID and T960506.ROW_WID = T961218.DT_WID and T960506.MCAL_CAL_WID = 1.0 and T961218.ORG_SCD1_WID = T964463.SCD1_WID and  TRUNC(T960506.MCAL_DAY_DT) = TO_DATE('2013-08-25' , 'YYYY-MM-DD') and T961218.ORG_DH_WID = T964333.ROW_WID and T964333.SCD1_WID = T964463.SCD1_WID and '2010' < T960506.CAL_YEAR ) 
group by T964333.DATASOURCE_NUM_ID, cast(T964333.ORG_HIER13_NUM as  INTEGER  ), concat(concat(T964333.ORG_HIER13_NUM, '~'), 'CHAIN'), concat(concat(cast(cast(T964463.ORG_NUM as  INTEGER  ) as  VARCHAR ( 20 ) ), '-'), T953980.ORG_NAME)
order by c1, c2, c6, c4

]]
[2013-08-26T15:25:51.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-18] [] [ecid: 0000K2tWvDhComWFLzYROA1I6e_Q000QjK] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Sending query to database named BBG_ANALIZE (id: <<1803028>>), connection pool named Oracle Data Warehouse Connection Pool, logical request hash d157cc34, physical request hash b1711efa: [[
...
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-34] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Query Status: Successful Completion [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-26] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Rows 161, bytes 718704 retrieved from database query id: <<1802067>> [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-28] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Physical query response time 51 (seconds), id <<1802067>> [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-26] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Rows 139, bytes 621608 retrieved from database query id: <<1802332>> [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-28] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Physical query response time 0 (seconds), id <<1802332>> [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-26] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Rows 151, bytes 672856 retrieved from database query id: <<1802554>> [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-28] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Physical query response time 0 (seconds), id <<1802554>> [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-26] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Rows 3, bytes 6216 retrieved from database query id: <<1803028>> [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-28] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Physical query response time 0 (seconds), id <<1803028>> [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-29] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Physical Query Summary Stats: Number of physical queries 4, Cumulative time 51, DB-connect time 0 (seconds) [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-24] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Rows returned to Client 176 [[

]]
[2013-08-26T15:26:42.000+00:00] [OracleBIServerComponent] [TRACE:2] [USER-33] [] [ecid: 0000K2tX7jGComWFLzYROA1I6e_Q000QkY] [tid: 45b8a940] [requestid: 4b37002d] [sessionid: 4b370000] [username: RAADMIN] -------------------- Logical Query Summary Stats: Elapsed time 52, Response time 51, Compilation time 1 (seconds) [[
