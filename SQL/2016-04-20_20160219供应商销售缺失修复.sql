--BBG_RA_SLS_CL_LC_DY_A,BBG_RA_SLS_DP_LC_DY_A二个表缺失2016.2.19日的销售数据。不明原因。
...
MERGE INTO RADM.BBG_RA_SLS_DP_LC_DY_A T 
USING (SELECT D.ORG_WID,
              D.ORG_DH_WID,
              D.ORG_SCD1_WID,
              D.PROD_DH_WID,
         ...
         FROM (SELECT /*+PARALLEL(16)*/
                ...
                SUM(A.BBG_REFERENCE_FO10) BBG_REFERENCE_FO10
                 FROM RADM.BBG_RA_SLS_SC_LC_DY_A A,
                      ...
                      RADM.W_PROD_CAT_DH         C
                WHERE A.PROD_DH_WID = B.ROW_WID
                  AND B.LVL6ANC_PRODCAT_ID = C.LVL6ANC_PRODCAT_ID
                  AND A.DT_WID = 120160219000
                  AND B.LEVEL_NAME = 'SBC'
                  AND C.LEVEL_NAME = 'DEPT'
                GROUP BY C.ROW_WID,
                         A.ORG_WID,
                         A.ORG_SCD1_WID,
                         A.ORG_DH_WID,
...
WHEN NOT MATCHED THEN
  INSERT
    (T.ROW_WID,
     ...
     T.BBG_REFERENCE_FO10)
  VALUES
    (RADM.BBG_RA_SLS_DP_LC_DY_A_SEQ.NEXTVAL,
     S.ORG_WID,
     S.ORG_DH_WID,
     S.ORG_SCD1_WID,
     S.PROD_DH_WID,
