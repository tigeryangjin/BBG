...
--销售接口
SELECT * FROM BBG_RA_SLS_TRX_JL_V@RA_JL WHERE DAY_DT = DATE '2015-09-25';
--供应商销售接口
SELECT * FROM BBG_RA_SUPP_SLS_JL_V@RA_JL WHERE DAY_DT = DATE '2015-09-25';
...
DELETE RADM.W_RTL_SLS_TRX_IT_LC_DY_F A
 WHERE A.DT_WID = 120150925000
   AND EXISTS
 (SELECT 1
          FROM BBG_RA_SLS_TRX_JL_V@RA_JL B
         WHERE B.DAY_DT = DATE '2015-09-25'
...
INSERT INTO RADM.W_RTL_SLS_TRX_IT_LC_DY_FS
  ...
  SELECT T.SLS_TRX_ID,
    ...
    FROM (SELECT SLS_TRX_ID,
           ...
           WHERE DAY_DT = DATE '2015-09-25') T;
...
--**********************************************************************************************************
--6.处理W_RTL_SLS_LC_DY_A
--**********************************************************************************************************
DELETE RADM.W_RTL_SLS_LC_DY_A T WHERE T.DT_WID = 120150925000;
COMMIT;
