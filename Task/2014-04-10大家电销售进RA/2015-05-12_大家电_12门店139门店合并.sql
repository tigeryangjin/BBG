...
CAST(CASE WHEN "RA"."Dim 每 Retail Organization As Was"."Loc Number" NOT LIKE '12%' THEN CAST("RA"."Dim 每 Retail Organization As Was"."Loc Number" AS VARCHAR(20)) ELSE '139' || Substring(CAST("RA"."Dim 每 Retail Organization As Was"."Loc Number" AS VARCHAR(20)) FROM - 3 FOR 3) END AS INT)
