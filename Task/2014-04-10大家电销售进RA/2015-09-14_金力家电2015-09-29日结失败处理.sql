...
--供应商销售接口
SELECT * FROM BBG_RA_SUPP_SLS_JL_V@RA_JL WHERE DAY_DT = &DAY_DT;
...
--删除供应商销售汇总表
DELETE /*+PARALLEL(16)*/
RADM.BBG_RA_SUPP_SALES_IT_LC_DY_F A
 WHERE A.DT_WID = &DT_WID
   AND EXISTS
 (SELECT /*+PARALLEL(16)*/
         1
...
DELETE /*+PARALLEL(16)*/
RADM.BBG_RA_SLS_SC_LC_DY_CUR_A A
 WHERE A.DT_WID = &DT_WID
   AND EXISTS
 (SELECT /*+PARALLEL(16)*/
         1
...
DELETE /*+PARALLEL(16)*/
RADM.BBG_RA_SLS_IT_LC_DY_SN_A A
 WHERE A.DT_WID = &DT_WID
   AND EXISTS
 (SELECT /*+PARALLEL(16)*/
         1
...
DELETE /*+PARALLEL(16)*/
RADM.BBG_RA_SLS_DP_LC_DY_CUR_A A
 WHERE A.DT_WID = &DT_WID
   AND EXISTS
 (SELECT /*+PARALLEL(16)*/
         1
...
DELETE /*+PARALLEL(16)*/
RADM.BBG_RA_SLS_CL_LC_DY_CUR_A A
 WHERE A.DT_WID = &DT_WID
   AND EXISTS
 (SELECT /*+PARALLEL(16)*/
         1
...
COMMIT;
DELETE RADM.BBG_RA_SLS_LC_DY_A T WHERE T.DT_WID = &DT_WID;
COMMIT;
...
using (Select /*+ APPEND */
        ...
        Where (1 = 1)
          AND BBG_RA_SLS_LC_DY_TMP.DT_WID = &DT_WID
