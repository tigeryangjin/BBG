 ...
 *
 ...
 WHERE T.DT_WID = 120150323000
   AND T.BBG_SERVICE_SATISFACTION = 3.5
   AND T.INTEGRATION_ID LIKE '%2400071022380%';
select *
  from W_RTL_SLS_TRX_IT_LC_DY_FS t
 WHERE T.PROD_IT_NUM = '2400071022380';
--ITEM_LOC重复 
SELECT /*+PARALLEL(T,20)*/
 *
...
--*******************************************************************************************************
--4.金力供应商销售导入RA
--ra_rms下创建BBG_RA_SUPP_SALES_CHECK_FV视图
select *
  from RA_RMS.BBG_RA_SUPP_SALES_CHECK_FV t
       
       --供应商销售数据插入FS表
         SELECT *
           FROM BBG_RA_SUPP_SLS_JL_V@RA_JL T
          WHERE T.DAY_DT = DATE '2015-04-13';
