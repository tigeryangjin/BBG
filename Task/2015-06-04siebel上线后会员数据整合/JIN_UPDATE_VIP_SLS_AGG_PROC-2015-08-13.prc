...
BEGIN
  ...
  BEGIN
    ...
    SELECT COUNT(1)
      INTO CNT
      FROM ALL_ALL_TABLES
     WHERE TABLE_NAME = 'VIP_TMP2';
    IF CNT = 1 THEN
      EXECUTE IMMEDIATE 'DROP TABLE RADM.VIP_TMP2';
    END IF;
    EXECUTE IMMEDIATE 'CREATE TABLE RADM.VIP_TMP2 AS
  SELECT /*+PARALLEL(16)*/
   P.PROD_CL_WID,
   B.RTL_TYPE_WID,
   B.DT_WID,
   ...
   GROUP BY P.PROD_CL_WID, B.RTL_TYPE_WID, B.DT_WID, B.BBG_RETAIL_TYPE_WID';
    EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX PK_VIP_TMP2 ON VIP_TMP2(PROD_CL_WID,
                                            RTL_TYPE_WID,
                                            DT_WID,
                                            BBG_RETAIL_TYPE_WID)';
    ...
    UPDATE /*+PARALLEL(16)*/ RADM.W_RTL_SLS_CL_DY_CUR_A A
       SET (A.VIP_SLS_QTY,
           ...
           (SELECT /*+PARALLEL(16)*/
             ...
             B.VIP_SLS_AMT,
             B.VIP_SLS_AMT_GLOBAL1,
             B.VIP_SLS_AMT_GLOBAL2,
             B.VIP_SLS_AMT_GLOBAL3,
             B.VIP_SLS_PROFIT_AMT,
             B.VIP_SLS_PROFIT_AMT_GLOBAL1,
             B.VIP_SLS_PROFIT_AMT_GLOBAL2,
             B.VIP_SLS_PROFIT_AMT_GLOBAL3,
             B.VIP_SLS_TAX_AMT,
             B.VIP_SLS_TAX_AMT_GLOBAL1,
             B.VIP_SLS_TAX_AMT_GLOBAL2,
             B.VIP_SLS_TAX_AMT_GLOBAL3,
             B.VIP_SLS_EMP_DISC_AMT,
             B.VIP_SLS_EMP_DISC_AMT_GLOBAL1,
             B.VIP_SLS_EMP_DISC_AMT_GLOBAL2,
             B.VIP_SLS_EMP_DISC_AMT_GLOBAL3,
             B.VIP_SLS_MANUAL_MKDN_AMT,
             B.V_SLS_MANUAL_MKDN_AMT_GLOBAL1,
             B.V_SLS_MANUAL_MKDN_AMT_GLOBAL2,
             B.V_SLS_MANUAL_MKDN_AMT_GLOBAL3,
             B.VIP_SLS_MANUAL_MKUP_AMT,
             B.V_SLS_MANUAL_MKUP_AMT_GLOBAL1,
             B.V_SLS_MANUAL_MKUP_AMT_GLOBAL2,
             B.V_SLS_MANUAL_MKUP_AMT_GLOBAL3,
             B.VIP_RET_AMT,
             B.VIP_RET_AMT_GLOBAL1,
             B.VIP_RET_AMT_GLOBAL2,
             B.VIP_RET_AMT_GLOBAL3,
             B.VIP_RET_PROFIT_AMT,
             B.VIP_RET_PROFIT_AMT_GLOBAL1,
             B.VIP_RET_PROFIT_AMT_GLOBAL2,
             B.VIP_RET_PROFIT_AMT_GLOBAL3,
             B.VIP_RET_TAX_AMT,
             B.VIP_RET_TAX_AMT_GLOBAL1,
             B.VIP_RET_TAX_AMT_GLOBAL2,
             B.VIP_RET_TAX_AMT_GLOBAL3,
             B.VIP_RET_EMP_DISC_AMT,
             B.VIP_RET_EMP_DISC_AMT_GLOBAL1,
             B.VIP_RET_EMP_DISC_AMT_GLOBAL2,
             B.VIP_RET_EMP_DISC_AMT_GLOBAL3,
             B.VIP_RET_MANUAL_MKDN_AMT,
             B.V_RET_MANUAL_MKDN_AMT_GLOBAL1,
             B.V_RET_MANUAL_MKDN_AMT_GLOBAL2,
             B.V_RET_MANUAL_MKDN_AMT_GLOBAL3,
             B.VIP_RET_MANUAL_MKUP_AMT,
             B.V_RET_MANUAL_MKUP_AMT_GLOBAL1,
             B.V_RET_MANUAL_MKUP_AMT_GLOBAL2,
             B.V_RET_MANUAL_MKUP_AMT_GLOBAL3,
             B.VIP_SLS_MANUAL_COUNT,
             B.VIP_SLS_SCAN_COUNT,
             B.VIP_RET_MANUAL_COUNT,
             B.VIP_RET_SCAN_COUNT
              FROM RADM.VIP_TMP2 B
  ...
  BEGIN
    ...
    SELECT COUNT(1)
      INTO CNT
      FROM ALL_ALL_TABLES
     WHERE TABLE_NAME = 'VIP_TMP5';
    IF CNT = 1 THEN
      EXECUTE IMMEDIATE 'DROP TABLE RADM.VIP_TMP5';
    END IF;
    EXECUTE IMMEDIATE 'CREATE TABLE RADM.VIP_TMP5 AS
  SELECT /*+PARALLEL(16)*/
   P.PROD_DP_WID,
   B.RTL_TYPE_WID,
   B.DT_WID,
   ...
   GROUP BY P.PROD_DP_WID, B.RTL_TYPE_WID, B.DT_WID, B.BBG_RETAIL_TYPE_WID';
    EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX PK_VIP_TMP5 ON VIP_TMP5(PROD_DP_WID,
                                            RTL_TYPE_WID,
                                            DT_WID,
                                            BBG_RETAIL_TYPE_WID)';
    ...
    UPDATE /*+PARALLEL(16)*/ RADM.W_RTL_SLS_DP_DY_CUR_A A
       SET (A.VIP_SLS_QTY,
           ...
           (SELECT /*+PARALLEL(16)*/
             ...
             B.VIP_RET_MANUAL_COUNT,
             B.VIP_RET_SCAN_COUNT
              FROM RADM.VIP_TMP5 B
             WHERE B.PROD_DP_WID = A.PROD_DH_WID
               AND A.RTL_TYPE_WID = B.RTL_TYPE_WID
               AND A.DT_WID = B.DT_WID
               AND A.BBG_RETAIL_TYPE_WID = B.BBG_RETAIL_TYPE_WID)
     WHERE A.VIP_SLS_QTY IS NULL
  ...
  BEGIN
    ...
    SELECT COUNT(1)
      INTO CNT
      FROM ALL_ALL_TABLES
     WHERE TABLE_NAME = 'VIP_TMP6';
    IF CNT = 1 THEN
      EXECUTE IMMEDIATE 'DROP TABLE RADM.VIP_TMP6';
    END IF;
    EXECUTE IMMEDIATE 'CREATE TABLE RADM.VIP_TMP6 AS
SELECT /*+PARALLEL(16)*/
 P.PROD_DP_WID,
 B.ORG_WID,
 B.RTL_TYPE_WID,
 ...
 GROUP BY P.PROD_DP_WID,
    ...
    EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX PK_VIP_TMP6 ON VIP_TMP6(PROD_DP_WID,
                                            ORG_WID,
                                            RTL_TYPE_WID,
                                            DT_WID,
                                            BBG_RETAIL_TYPE_WID)';
  ...
  BEGIN
    ...
    SELECT COUNT(1)
      INTO CNT
      FROM ALL_ALL_TABLES
     WHERE TABLE_NAME = 'VIP_TMP11';
    IF CNT = 1 THEN
      EXECUTE IMMEDIATE 'DROP TABLE RADM.VIP_TMP11';
    END IF;
    EXECUTE IMMEDIATE 'CREATE TABLE RADM.VIP_TMP11 AS
  SELECT /*+PARALLEL(16)*/
   B.PROD_WID,
   B.ORG_WID,
   B.RTL_TYPE_WID,
   ...
   GROUP BY B.PROD_WID,
            ...
            S.SEASON_WID,
            B.BBG_RETAIL_TYPE_WID';
    EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX PK_VIP_TMP11 ON VIP_TMP11(PROD_WID,
		                                                              ORG_WID,
                                                                  RTL_TYPE_WID,
                                                                  DT_WID,
																																	SEASON_WID,
    ...
    UPDATE /*+PARALLEL(16)*/ RADM.W_RTL_SLS_IT_LC_DY_SN_A A
       SET (A.VIP_SLS_QTY,
           ...
           (SELECT /*+PARALLEL(16)*/
             ...
             B.VIP_RET_TAX_AMT_LCL,
             B.VIP_RET_EMP_DISC_AMT_LCL
              FROM RADM.VIP_TMP11 B
             WHERE A.PROD_WID = B.PROD_WID
               AND A.ORG_WID = B.ORG_WID
               AND A.RTL_TYPE_WID = B.RTL_TYPE_WID
               AND A.DT_WID = B.DT_WID
               AND A.SEASON_WID = B.SEASON_WID
               AND A.BBG_RETAIL_TYPE_WID = B.BBG_RETAIL_TYPE_WID)
     WHERE A.VIP_SLS_QTY IS NULL
       AND A.DT_WID = DTWID;
    COMMIT;
  ...
  BEGIN
    ...
    SELECT COUNT(1)
      INTO CNT
      FROM ALL_ALL_TABLES
     WHERE TABLE_NAME = 'VIP_TMP12';
    IF CNT = 1 THEN
      EXECUTE IMMEDIATE 'DROP TABLE RADM.VIP_TMP12';
    END IF;
    EXECUTE IMMEDIATE 'CREATE TABLE RADM.VIP_TMP12 AS
  SELECT /*+PARALLEL(16)*/
   B.ORG_WID,
   B.RTL_TYPE_WID,
   B.DT_WID,
   ...
   GROUP BY B.ORG_WID,
            ...
            B.DT_WID,
            B.BBG_RETAIL_TYPE_WID';
    EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX PK_VIP_TMP12 ON VIP_TMP12(ORG_WID,
                                                                  RTL_TYPE_WID,
                                                                  DT_WID,
                                                                  BBG_RETAIL_TYPE_WID)';
  ...
  BEGIN
    ...
    SELECT COUNT(1)
      INTO CNT
      FROM ALL_ALL_TABLES
     WHERE TABLE_NAME = 'VIP_TMP13';
    IF CNT = 1 THEN
      EXECUTE IMMEDIATE 'DROP TABLE RADM.VIP_TMP13';
    END IF;
    EXECUTE IMMEDIATE 'CREATE TABLE RADM.VIP_TMP13 AS
  SELECT /*+PARALLEL(16)*/
   P.PROD_SC_WID,
   B.RTL_TYPE_WID,
   B.DT_WID,
   ...
   GROUP BY P.PROD_SC_WID, B.RTL_TYPE_WID, B.DT_WID, B.BBG_RETAIL_TYPE_WID';
    EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX PK_VIP_TMP13 ON VIP_TMP13(PROD_SC_WID,
                                                                  RTL_TYPE_WID,
                                                                  DT_WID,
                                                                  BBG_RETAIL_TYPE_WID)';
  ...
  BEGIN
    ...
    SELECT COUNT(1)
      INTO CNT
      FROM ALL_ALL_TABLES
     WHERE TABLE_NAME = 'VIP_TMP14';
    IF CNT = 1 THEN
      EXECUTE IMMEDIATE 'DROP TABLE RADM.VIP_TMP14';
    END IF;
    EXECUTE IMMEDIATE 'CREATE TABLE RADM.VIP_TMP14 AS
										SELECT /*+PARALLEL(16)*/
										 P.PROD_SC_WID,
										 B.RTL_TYPE_WID,
										 B.DT_WID,
										 ...
										 WHERE B.PROD_SCD1_WID = P.PROD_SCD1_WID
											 AND P.CURRENT_FLG = ''Y''
										 GROUP BY P.PROD_SC_WID, B.RTL_TYPE_WID, B.DT_WID, B.BBG_RETAIL_TYPE_WID';
    EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX PK_VIP_TMP14 ON VIP_TMP14(PROD_SC_WID,
																																	RTL_TYPE_WID,
																																	DT_WID,
																																	BBG_RETAIL_TYPE_WID)';
