...
-- ADD/MODIFY COLUMNS 
ALTER TABLE RADM.W_RTL_SLS_IT_LC_MN_A ADD SLS_COUPON_AMT_LCL NUMBER(20,4);
ALTER TABLE RADM.W_RTL_SLS_IT_LC_MN_A ADD RET_COUPON_AMT_LCL NUMBER(20,4);
ALTER TABLE RADM.W_RTL_SLS_IT_LC_MN_A ADD SLS_TAX_COUPON_AMT_LCL NUMBER(20,4);
ALTER TABLE RADM.W_RTL_SLS_IT_LC_MN_A ADD RET_TAX_COUPON_AMT_LCL NUMBER(20,4);
-- ADD COMMENTS TO THE COLUMNS 
COMMENT ON COLUMN RADM.W_RTL_SLS_IT_LC_MN_A.SLS_COUPON_AMT_LCL
  IS '券销售金额(50,51,52)';
COMMENT ON COLUMN RADM.W_RTL_SLS_IT_LC_MN_A.RET_COUPON_AMT_LCL
  IS '券退货金额(50,51,52)';
COMMENT ON COLUMN RADM.W_RTL_SLS_IT_LC_MN_A.SLS_TAX_COUPON_AMT_LCL
  IS '券销售金额(50,51,52)税额';
COMMENT ON COLUMN RADM.W_RTL_SLS_IT_LC_MN_A.RET_TAX_COUPON_AMT_LCL
  IS '券退货金额(50,51,52)税额';
