...
--CREATE TABLE 
CREATE TABLE RADM.BBG_RA_SLS_MBA_LC_DY_F AS
SELECT * FROM RADM.BBG_RA_SLS_MBA_LC_DY_FV T WHERE T.DT_WID=120160301000;


--ODI
--interface1:source£ºRADM.BBG_RA_SLS_MBA_LC_DY_FV           target:RABATCHER.BBG_RA_SLS_MBA_LC_DY_TMP
--interface2:source£ºRABATCHER.BBG_RA_SLS_MBA_LC_DY_TMP     target:RADM.BBG_RA_SLS_MBA_LC_DY_A
--interface3:source£ºRABATCHER.BBG_RA_SLS_MBA_LC_DY_TMP     target:RADM.BBG_RA_SLS_MBA_DY_A
