...
--1.3.1.CREATE TABLE
CREATE TABLE RADM.W_RTL_SLS_TRX_CL_LC_DY_A
( ROW_WID                     NUMBER(10) NOT NULL,
  ORG_WID                     NUMBER(10) NOT NULL,
  ORG_DH_WID                  NUMBER(10) NOT NULL,
  ORG_SCD1_WID                NUMBER(10) NOT NULL,
  ...
  VIP_RET_SCAN_COUNT          NUMBER(18,4));
--1.3.2.CREATE INDEX
ALTER TABLE RADM.W_RTL_SLS_TRX_CL_LC_DY_A
  ADD CONSTRAINT PK_W_RTL_SLS_TRX_CL_LC_DY_A PRIMARY KEY (SLS_TRX_ID, VOUCHER_ID, DT_WID, PROD_DH_WID, ORG_WID)
  USING INDEX 
  TABLESPACE DM_FACT_INDEX
  PCTFREE 10
  INITRANS 12
...
--1.3.3.CREATE SEQ
CREATE SEQUENCE W_RTL_SLS_TRX_CL_LC_DY_A_SEQ
MINVALUE 1
MAXVALUE 9999999999999999999999999999
START WITH 1
INCREMENT BY 1
CACHE 20000;
--1.3.4.INSERT TEST DATA
--one day 679M
INSERT INTO RADM.W_RTL_SLS_TRX_CL_LC_DY_A
  SELECT W_RTL_SLS_TRX_CL_LC_DY_A_SEQ.NEXTVAL ROW_WID, A.*
    FROM (SELECT F.ORG_WID,
                 F.ORG_DH_WID,
                 F.ORG_SCD1_WID,
                 P.PROD_CL_WID,
                 ...
                 '' GLOBAL2_EXCHANGE_RATE,
                 '' GLOBAL3_EXCHANGE_RATE,
                 F.SLS_TRX_ID || '~' || F.VOUCHER_ID || '~' ||P.PROD_CL_NUM||'~'||
                 TO_CHAR(TO_DATE(SUBSTR(F.DT_WID, 2, 8), 'YYYYMMDD'),
                         'DD-MON-YY',
                         'NLS_DATE_LANGUAGE=American') INTEGRATION_ID,
                 'CNY' LOC_CURR_CODE,
...
--1.4.1.CREATE TABLE
CREATE TABLE RADM.W_RTL_SLS_TRX_SC_LC_DY_A
( ROW_WID                     NUMBER(10) NOT NULL,
  ORG_WID                     NUMBER(10) NOT NULL,
  ORG_DH_WID                  NUMBER(10) NOT NULL,
  ORG_SCD1_WID                NUMBER(10) NOT NULL,
  ...
  VIP_RET_SCAN_COUNT          NUMBER(18,4));
--1.4.2.CREATE INDEX
ALTER TABLE RADM.W_RTL_SLS_TRX_SC_LC_DY_A
  ADD CONSTRAINT PK_W_RTL_SLS_TRX_SC_LC_DY_A PRIMARY KEY (SLS_TRX_ID, VOUCHER_ID, DT_WID, PROD_DH_WID, ORG_WID)
  USING INDEX 
  TABLESPACE DM_FACT_INDEX
  PCTFREE 10
  INITRANS 12
...
--1.4.3.CREATE SEQ
CREATE SEQUENCE W_RTL_SLS_TRX_SC_LC_DY_A_SEQ
MINVALUE 1
MAXVALUE 9999999999999999999999999999
START WITH 1
INCREMENT BY 1
CACHE 20000;
--1.4.4.INSERT TEST DATA
INSERT INTO RADM.W_RTL_SLS_TRX_SC_LC_DY_A
  SELECT W_RTL_SLS_TRX_SC_LC_DY_A_SEQ.NEXTVAL ROW_WID, A.*
    FROM (SELECT F.ORG_WID,
                 F.ORG_DH_WID,
                 F.ORG_SCD1_WID,
                 P.PROD_SC_WID,
                 ...
                 '' GLOBAL2_EXCHANGE_RATE,
                 '' GLOBAL3_EXCHANGE_RATE,
                 F.SLS_TRX_ID || '~' || F.VOUCHER_ID || '~' ||P.PROD_SC_NUM||'~'||
                 TO_CHAR(TO_DATE(SUBSTR(F.DT_WID, 2, 8), 'YYYYMMDD'),
                         'DD-MON-YY',
                         'NLS_DATE_LANGUAGE=American') INTEGRATION_ID,
                 'CNY' LOC_CURR_CODE,
