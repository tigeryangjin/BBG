...
--2.BIEE SQL
  SELECT DISTINCT 0 AS c1,
    ...
    FROM (  SELECT SUM (
                      CASE
                         WHEN NOT T1051080.N69_NET_SALES_AMT_INC_TAX < 138
                         THEN
                   ...
                   SUM (
                      CASE
                         WHEN NOT T1051080.N69_NET_SALES_AMT_INC_TAX < 88
                         THEN
                            T1051080.N69_NET_SALES_AMT_INC_TAX
                      END)
                      AS c2,
                   SUM (
                      CASE
                         WHEN NOT T1051080.VIP_N69_NET_SALES_AMT_INC_TAX < 138
                         THEN
                   ...
                   SUM (
                      CASE
                         WHEN NOT T1051080.VIP_N69_NET_SALES_AMT_INC_TAX < 88
                         THEN
                            T1051080.VIP_N69_NET_SALES_AMT_INC_TAX
                      END)
                      AS c4,
             ...
             WHERE (    T960506.ROW_WID = T1051080.DT_WID
                    AND T960506.MCAL_CAL_WID = 1.0
                    AND '2010' < T960506.CAL_YEAR
                    AND (   T1051080.N69_NET_SALES_AMT_INC_TAX >= 88
                         OR T1051080.N69_NET_SALES_AMT_INC_TAX >= 138
                         OR T1051080.VIP_N69_NET_SALES_AMT_INC_TAX >= 88
                         OR T1051080.VIP_N69_NET_SALES_AMT_INC_TAX >= 138)
