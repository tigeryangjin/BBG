...
--8.
--CN_Retail_As-Was_Item_As_Was_BBG_Primary_Barcode	 
--CD_Retail_As-Was_Item_As_Was_BBG_Primary_Barcode
SELECT * FROM RADM.W_LOCALIZED_STRING_G T WHERE T.MSG_NUM LIKE '%Retail_As-Was_Item_As_Was_BBG_Primary_Barcode' FOR UPDATE;
