...
TBL_NAME="TMP"
SCEN_NAME="PLP_BBG_RETAILSALESMARKDOWNSNAGGREGATE"

echo "LOADING TABLE=TMP" 
startscen.sh $SCEN_NAME $VERSION $CONTEXT RA_BI.RA_TABLENAME=${TBL_NAME}


TBL_NAME="W_RTL_MKDN_IT_LC_DY_SN_A"
SCEN_NAME="PLP_BBG_RETAILSALESMARKDOWNSNAGGREGATE"

echo "LOADING TABLE=W_RTL_MKDN_IT_LC_DY_SN_A" 
startscen.sh $SCEN_NAME $VERSION $CONTEXT RA_BI.RA_TABLENAME=${TBL_NAME}
