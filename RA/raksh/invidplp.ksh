...
TBL_NAME="TMP"
SCEN_NAME="PLP_RETAILINVPOSITIONCORPORATEORGITSCDYWKAGGREGATE"

echo "LOADING TABLE =W_RTL_INV_IT_DY_TMP" 
startscen.sh $SCEN_NAME $VERSION $CONTEXT RA_BI.RA_TABLENAME=${TBL_NAME}


TBL_NAME="W_RTL_INV_IT_DY_A"  
SCEN_NAME="PLP_RETAILINVPOSITIONCORPORATEORGITSCDYWKAGGREGATE"

echo "LOADING TABLE =W_RTL_INV_IT_DY_A" 
startscen.sh $SCEN_NAME $VERSION $CONTEXT RA_BI.RA_TABLENAME=${TBL_NAME}
