--2017.1.18-139211-102054211
--1.
DELETE RADM.W_RTL_SLS_TRX_IT_LC_DY_FS T WHERE T.ORG_NUM<>139211;
COMMIT;
DELETE RADM.W_RTL_SLS_TRX_IT_LC_DY_FS T WHERE T.PROD_IT_NUM<>102054211;
COMMIT;
