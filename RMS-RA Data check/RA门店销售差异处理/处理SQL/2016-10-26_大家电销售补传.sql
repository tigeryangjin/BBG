...
--139211.2400071027351
--139164.2400070072496
SELECT *
  FROM BBG_RA_SLS_TRX_JL_V@RA_JL A
 WHERE A.DAY_DT = DATE '2016-10-26'
...
--2.SIL
--2.1.ITEM_LOC_DIM
CALL bbg_jl_item_loc_new_proc(new_loc => 139211);
CALL bbg_jl_item_loc_new_proc(new_loc => 139164);

SELECT * FROM RADM.BBG_RA_ITEM_LOC_DS;
SELECT * FROM RADM.BBG_RA_ITEM_LOC_D T WHERE T.ITEM='2400071027351' AND T.LOC='139211';
SELECT * FROM RADM.BBG_RA_ITEM_LOC_D T WHERE T.ITEM='2400070072496' AND T.LOC='139164';

--2.2.SALES SIL
TRUNCATE TABLE RADM.C_LOAD_DATES;

CREATE TABLE RADM.W_RTL_SLS_TRX_IT_LC_DY_FS_1026 AS
...
INSERT INTO RADM.W_RTL_SLS_TRX_IT_LC_DY_FS
  SELECT *
    FROM RADM.W_RTL_SLS_TRX_IT_LC_DY_FS_1026 T
   WHERE (T.ORG_NUM = '139211' AND T.PROD_IT_NUM = '2400071027351')
      OR (T.ORG_NUM = '139164' AND T.PROD_IT_NUM = '2400070072496');
COMMIT;
...
INSERT INTO RADM.BBG_RA_SLS_IT_LC_DY_FS
  SELECT *
    FROM RADM.BBG_RA_SLS_IT_LC_DY_FS_BAK T
   WHERE (T.ORG_NUM = '139211' AND T.PROD_IT_NUM = '2400071027351')
      OR (T.ORG_NUM = '139164' AND T.PROD_IT_NUM = '2400070072496');
COMMIT;
