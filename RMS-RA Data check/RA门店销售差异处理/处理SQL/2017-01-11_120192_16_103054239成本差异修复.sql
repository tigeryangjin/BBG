--2017.1.11-120192-103054239
--1.
DELETE RADM.W_RTL_SLS_TRX_IT_LC_DY_FS T WHERE T.ORG_NUM<>120192;
COMMIT;
DELETE RADM.W_RTL_SLS_TRX_IT_LC_DY_FS T WHERE T.PROD_IT_NUM<>103054239;
COMMIT;
...
UPDATE RADM.W_RTL_SLS_TRX_IT_LC_DY_FS T
   SET T.SLS_QTY                 = 0,
       ...
       T.RET_QTY                 = 0,
       T.RET_AMT_LCL             = 0,
       T.RET_PROFIT_AMT_LCL      = -32.2393*2,
