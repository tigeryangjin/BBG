...
SELECT * FROM RA_RMS.BBG_XTERN_RDWT_HIST WHERE BUSINESS_DT= '20140112';
...
--删除12月12日的打包商品销售记录
DELETE W_RTL_SLSPK_IT_LC_DY_F@RMS_RA T WHERE T.DT_WID='120140112000';
DELETE W_RTL_SLSPK_IT_DY_A@RMS_RA T WHERE T.DT_WID='120140112000';
...
SELECT * FROM  W_RTL_SLSPK_IT_LC_DY_F@RMS_RA T WHERE T.DT_WID='120140112000';
SELECT * FROM  W_RTL_SLSPK_IT_DY_A@RMS_RA T WHERE T.DT_WID='120140112000';
