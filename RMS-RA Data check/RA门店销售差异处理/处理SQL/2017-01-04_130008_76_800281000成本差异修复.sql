--1.
DELETE RADM.W_RTL_SLS_TRX_IT_LC_DY_FS T WHERE T.ORG_NUM<>130008;
COMMIT;
DELETE RADM.W_RTL_SLS_TRX_IT_LC_DY_FS T WHERE T.PROD_IT_NUM<>800281000;
COMMIT;
