SELECT *
 ...
 WHERE T.BBG_SERVICE_SATISFACTION = 3.5;
SELECT *
  FROM BBG_RA_SLS_TRX_JL_V@RA_JL T
 WHERE T.DAY_DT = DATE '2016-09-17';
...
SELECT *
 ...
 WHERE T.DAY_DT = DATE '2016-09-17'
   AND NOT EXISTS (SELECT 1
          FROM RABATCHER.W_RTL_SLS_TRX_IT_LC_DY_TMP S
         WHERE S.BBG_SERVICE_SATISFACTION = 3.5
...
DELETE RADM.W_RTL_SLS_TRX_IT_LC_DY_FS T
 WHERE EXISTS (SELECT 1
          FROM RABATCHER.W_RTL_SLS_TRX_IT_LC_DY_TMP S
         WHERE T.ORG_NUM = S.ORG_NUM
           AND T.PROD_IT_NUM = S.PROD_IT_NUM
           AND S.BBG_SERVICE_SATISFACTION = 3.5);

SELECT *
  FROM RADM.BBG_RA_ITEM_LOC_D T
 WHERE T.ITEM = '2400072022635'
   AND T.LOC = 139255;
...
DISTINCT A.DAY_DT, A.ORG_NUM, A.PROD_IT_NUM
 ...
 WHERE A.DAY_DT = DATE '2016-09-16'
