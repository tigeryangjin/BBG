--2017-02-08,120152,13,103119514,6.77
--2017-02-08,120152,13,103316235,6.77
...
INSERT INTO RADM.W_RTL_SLS_TRX_IT_LC_DY_FS
  SELECT *
   ...
   WHERE T.ORG_NUM = 120152
     AND T.PROD_IT_NUM = 103119514;
COMMIT;
INSERT INTO RADM.W_RTL_SLS_TRX_IT_LC_DY_FS
  SELECT *
    FROM RADM.W_RTL_SLS_TRX_IT_LC_DY_FS_BAK T
   WHERE T.ORG_NUM = 120152
     AND T.PROD_IT_NUM = 103316235;
COMMIT;
