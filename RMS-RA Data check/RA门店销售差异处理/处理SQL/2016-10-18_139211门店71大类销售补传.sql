--2016.10.18 loc:139211 dept:71 item:2400071060074
--***********************************************************
--SALES
--***********************************************************
--1.
...
SELECT *
 ...
 WHERE T.PROD_IT_NUM = '2400071060074'
   AND T.ORG_NUM = '139211';
COMMIT;
...
SELECT * FROM RADM.BBG_RA_SLS_IT_LC_DY_FS_BAK T WHERE T.ORG_NUM='139211' AND T.PROD_IT_NUM='2400071060074';
COMMIT;
